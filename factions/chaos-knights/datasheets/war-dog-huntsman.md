...
| Daemonbreath spear | 18 | 2 | 3 | 12 | -4 | D6 | melta 4 |
...
- **Huntsman** (Datasheet): Each time this model makes an attack that targets a MONSTER or VEHICLE unit, you can re-roll the Wound roll.

**Keywords:** Huntsman, War Dog, Walker, Vehicle, Chaos
