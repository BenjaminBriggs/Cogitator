...
- **Consumed with Hunger (Aura)** (Datasheet): While a friendly War Dog model is within 6" of this model, each time that WAR DOG model makes an attack that targets a TITANIC or TOWERING unit, you can re-roll the Hit roll.

**Keywords:** Walker, Knight Atrapos, Cerastus, Chaos, Towering, Titanic, Vehicle, Character
