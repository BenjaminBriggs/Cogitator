...
|---|---|---|---|---|---|---|---|
| Relic gauss blaster | 24 | 2 | 3 | 5 | -1 | 2 | lethal hits, rapid fire 2 |
...
- **Adaptive Strategy** (Datasheet): This model’s unit is eligible to shoot and declare a charge in a turn in which it Fell Back.
- **Engrammatic Logic** (Datasheet): Once per battle, at the start of any phase, you can select one friendly NECRONS unit that is Battle-shocked and within 12" of this model. That unit is no longer Battle-shocked.

**Keywords:** Character, Royal Warden, Infantry
