...
- **Trail Finding** (Datasheet): Once per turn, when an enemy unit ends a Normal, Advance or Fall Back move within 9" of this model’s unit, if this model’s unit is not within Engagement Range of one or more enemy units, it can make a Normal move of up to D6".
- **Kroot Ambush** (Datasheet): After both players have deployed their armies, you can redeploy this model’s unit and one other friendly Kroot unit. When doing so, any of those units can be placed into Strategic Reserves, regardless of how many units are already in Strategic Reserves.

**Keywords:** Infantry, Trail Shaper, Shaper, Character, Kroot
...
**Leader:**
Can lead: Kroot Farstalkers, Kroot Carnivores
