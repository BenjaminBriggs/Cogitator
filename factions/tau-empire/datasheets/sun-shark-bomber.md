...
| Twin missile pod | 30 | 2 | 4 | 7 | -1 | 2 | twin-linked |
| Seeker missile | 48 | 1 | 4 | 14 | -3 | D6+1 | one shot |
| Twin ion rifle – standard | 30 | 3 | 4 | 7 | -1 | 1 | twin-linked |
| Twin ion rifle – overcharge | 30 | 3 | 4 | 8 | -2 | 2 | hazardous, twin-linked |
...
- **Pulse Bombs** (Datasheet): Each time this model ends a Normal move, you can select one enemy unit it moved over during that move and roll six D6: for each 4+, that unit suffers 1 mortal wound.
- **One Shot** (Wargear profile): The bearer can only shoot with this weapon once per battle.

**Keywords:** Sun Shark Bomber, Fly, Aircraft, Vehicle
