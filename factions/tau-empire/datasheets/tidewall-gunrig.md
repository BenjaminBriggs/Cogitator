...
|---|---|---|---|---|---|---|---|
| Supremacy railgun | 72 | 1 | 5 | 20 | -5 | D6+6 | devastating wounds, twin-linked |
...
- **Tidewall Cover** (Datasheet): Each time a ranged attack is allocated to a model, if that model is not fully visible to every model in the attacking unit because of this FORTIFICATION, that model has the Benefit of Cover against that attack.

**Keywords:** Tidewall Gunrig, Fortification, Fly, Transport, Vehicle
