...
*When a Brôkhyr hooks into a powerful exoframe, they become Thunderkyn. Adapted from rigs used to maintain Kin spacecraft, these armoured exoskeletons exchange repair tools for massive heavy weapons, which the Brôkhyr use to lay down withering covering fire for the oathbands and to pick off enemy armour.*
...
|---|---|---|---|---|---|---|---|
| Bolt cannon | 36 | 3 | 4 | 6 | -1 | 2 | sustained hits 2 |
| Graviton blast cannon | 24 | 3 | 4 | 5 | -2 | 3 | anti-monster 3+, anti-vehicle 3+ |
...
- **Breaching Fire** (Datasheet): In your Shooting phase, after this unit has shot, select one enemy unit hit by one or more of those attacks. Until the start of your next Shooting phase, that enemy unit cannot have the Benefit of Cover.
- **Conversion** (Wargear profile): Each time an attack made with this weapon targets an enemy unit that is not within 12", an unmodified Hit roll of 4+ scores a Critical Hit.
