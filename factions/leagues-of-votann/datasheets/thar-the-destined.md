...
*Already one of the most accomplished heroes of the Kin, Kâhl Ûthar the Destined is marked for a truly vaunted fate. Few can assess the foe as swiftly or mercilessly as Ûthar. Once he has the measure of his enemies, he soon cuts them to pieces with the glowing Blade of the Ancestors.*
...
- **Ancestral Fortune** (Datasheet): Once per turn, you can spend 1YP to change one Hit roll, one Wound roll or one saving throw made for this model to an unmodified 6.
- **Grim Efficiency** (Datasheet): Once per battle round, when a friendly Leagues of Votann unit within 12“ of this model is targeted with a Stratagem, this model can use this ability. If it does, reduce the CP cost of that use of that Stratagem by 1CP.
- **Rampart Crest** (Wargear): While the bearer is leading a unit, models in that unit have a 5+ invulnerable save.

**Keywords:** Kâhl, Epic Hero, Character, Infantry, Ûthar the Destined
...
**Leader:**
Can lead: Hearthkyn Warriors, Einhyr Hearthguard
