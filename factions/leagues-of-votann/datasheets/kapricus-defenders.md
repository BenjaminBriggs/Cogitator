...
|---|---|---|---|---|---|---|---|
| HYLas rotary cannon | 24 | 6 | 4 | 6 | -1 | 2 | sustained hits 1 |
...
- **Opportunistic Manoeuvre** (Datasheet): In your Shooting phase, after this unit has shot, it can make a Normal move of up to D6". If it does, until the end of the turn, this unit is not eligible to declare a charge.
- **Smoke Launcher** (Wargear): The bearer has the SMOKE keyword.

**Keywords:** Kapricus, Defenders, Hernkyn, Vehicle, Fly
