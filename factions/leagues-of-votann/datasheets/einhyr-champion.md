...
- **Exemplar of the Einhyr** (Datasheet): While this model is leading a unit, add 1 to Advance and Charge rolls made for that unit.
- **Mass Driver Accelerators** (Datasheet): Each time this model ends a Charge move, you can select one enemy unit within Engagement Range of this model and roll one D6: on a 2-5, that enemy unit suffers D3 mortal wounds; on a 6, that enemy unit suffers D3+3 mortal wounds.
- **Teleport Crest** (Wargear): While the bearer is leading a unit, models in that unit have the Deep Strike ability.
- **Weavefield Crest** (Wargear): The bearer has a 4+ invulnerable save.

**Keywords:** Exoarmour, Infantry, Character, Einhyr Champion
