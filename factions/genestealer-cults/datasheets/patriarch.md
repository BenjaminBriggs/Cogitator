...
- **Might From Beyond** (Datasheet): While this model is leading a unit, melee weapons equipped by models in that unit have the [DEVASTATING WOUNDS] ability.
- **Cosmic Horror (Psychic)** (Datasheet): At the start of the Fight phase, each enemy unit within 6" of this model must take a Battle-shock test.
- **Psychic Familiar** (Datasheet): Once per battle, at the start of the Fight phase, this model can use its psychic familiar. If it does, until the end of the phase, add 6" to the range of its Cosmic Horror ability.

**Designer’s Note:** *Place a Psychic Familiar token next to the model, removing it once this ability has been used.*
- **SUPREME COMMANDER** (Special (правая колонка)): - You cannot include more than one PATRIARCH model in your army.
- If this model is in your army, it must be your Warlord.

**Keywords:** Patriarch, Great Devourer, Psyker, Character, Infantry
...
**Leader:**
Can lead: Purestrain Genestealers
