...
| Name | M | T | Sv | W | Ld | OC |
|---|---|---|---|---|---|---|
| QUARTERMASTER REVENANT | 6" | 3 | 4+ | 3 | 7+ | 1 |
| MEDICAE SERVITOR | 6" | 3 | 4+ | 1 | 8+ | 0 |
...
|---|---|---|---|---|---|---|---|
| Medical scalpels | Melee | 1 | 5 | 3 | 0 | 1 | — |
| Quartermaster’s close combat weapon | Melee | 2 | 3 | 4 | -2 | 1 | — |
...
- **Medicae Medi-packs** (Datasheet): Whilst this unit contains one or more Medicae Servitors, models in this unit have the Feel No Pain 5+ ability.
- **Mindlock** (Datasheet): While this unit contains a Quartermaster Revenant model, improve the Weapon Skill characteristic of this unit’s Medical scalpels by 1.

**Keywords:** Character, Quartermaster Cadre Squad, Infantry, Imperium, Grenades, Regiment
...
**Leader:**
Can lead: Death Korps Of Krieg, Death Korps Grenadier Squad
