...
|---|---|---|---|---|---|---|---|
| Tauros grenade launcher – frag | 24 | D6 | 4 | 4 | 0 | 1 | blast |
...
- **Turbo-boost** (Datasheet): Each time this model Advances, do not make an Advance roll for it. Instead, until the end of the phase, add 6" to the Move characteristic of this model.
- **One Shot** (Wargear profile): The bearer can only shoot with this weapon once per battle.

**Keywords:** Imperium, Tauros Assault Vehicle, Mounted, Regiment, Tauros
