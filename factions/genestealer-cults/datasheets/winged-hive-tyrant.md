...
- **Will of the Hive Mind** (Datasheet): Once per battle round, one model from your army with this ability can use it when a friendly TYRANIDS unit within 12" of that model is targeted with a Stratagem. If it does, reduce the CP cost of that usage of that Stratagem by 1CP.
- **Paroxysm (Psychic)** (Datasheet): At the start of the Fight phase, you can select one enemy unit within 12" of and visible to this model and roll one D6: on a 1, this PSYKER suffers D3 mortal wounds; on a 2+, until the end of the phase, subtract 1 from the Attacks characteristic of weapons equipped by models in that unit.

**Keywords:** Monster, Hive Tyrant, Vanguard Invader, Winged Hive Tyrant, Character, Psyker, Fly, Great Devourer, Synapse
...
**Wargear Options:**
- This model’s monstrous bonesword and lash whip can be replaced with one of the following:- 1 heavy venom cannon
