...
| Malcador battle cannon | 48 | D6+3 | 4 | 9 | -1 | 3 | blast |
...
- **Rugged Reliability** (Datasheet): Each time a ranged attack targets this model, worsen the Armour Penetration characteristic of that attack by 1.
- **One Shot** (Wargear profile): The bearer can only shoot with this weapon once per battle.

**Keywords:** Vehicle, Smoke, Malcador, Squadron, Imperium
...
**Wargear Options:**
- This model’s 2 autocannons can be replaced with one of the following:- 2 heavy bolters
- 2 lascannons
- This model’s heavy bolter can be replaced with one of the following:- 1 autocannon
- 1 lascannon
