...
- **Unholy Power** (Datasheet): Each time this model’s unit makes a Dark Pact, until the end of the phase, each time this model makes a Psychic Attack, add 1 to the Wound roll.

**Keywords:** Psyker, Chaos, Grenades, Mounted, Character, Sorcerer on Bike
