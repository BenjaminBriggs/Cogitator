...
| Exalted weapon | Melee | 6 | 2 | 5 | -2 | 2 | — |
| Paired accursed weapons | Melee | 7 | 2 | 5 | -2 | 1 | twin-linked |
...
- **Formidably Resilient** (Datasheet): Each time an attack is allocated to this model, halve the Damage characteristic of that attack.

**Keywords:** Character, Chaos, Terminator, Chaos Lord in Terminator Armour, Infantry, Chaos Lord
...
- This model’s exalted weapon can be replaced with one of the following:- 1 chainfist
- 1 power fist
