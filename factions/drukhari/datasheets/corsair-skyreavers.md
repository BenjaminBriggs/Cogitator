...
**Default Wargear:**
**Every model is equipped with:** shuriken pistol; Corsair blade.
...
| Fusion gun | 12 | 1 | 3 | 8 | -4 | D6 | assault, melta 2 |
| Flamer | 12 | D6 | N/A | 4 | 0 | 1 | assault, ignores cover, torrent |
| Blast pistol | 6 | 1 | 3 | 8 | -3 | D3 | assault, pistol |
...
- **Raid and Run** (Datasheet): At the end of the Fight phase, if this unit was eligible to fight this phase, and is not within Engagement Range of one or more enemy units, it can make a Normal move of up to D3+3". Otherwise, if this unit was eligible to fight this phase, this unit can make a Fall Back move of up to D3+3".

**Keywords:** Corsair Skyreavers, Grenades, Anhrathe, Aeldari, Fly, Jump Pack, Infantry
...
**Wargear Options:**
- The Skyreaver Felarch can replace its shuriken pistol with one of the following:- 1  blast pistol
- 1 neuro disruptor
- For every 5 models in the unit, up to 2 Skyreaver models can each have their shuriken pistol and Corsair blade replaced with one of the following*:- 1 blaster and 1 close combat weapon
