...
|---|---|---|---|---|---|---|---|
| Purifying Flame | 18 | 3 | 2 | 4 | -2 | 1 | anti-infantry 2+, ignores cover, psychic |
| Storm bolter | 24 | 2 | 2 | 4 | 0 | 1 | rapid fire 2 |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Black Blade of Antwyr | Melee | 5 | 2 | 6 | -2 | 2 | devastating wounds, precision |
...
- **Champion of the Order of Purifiers (Psychic)** (Datasheet): While this model is leading a unit, add 1 to the Attacks characteristic of Purifying Flame weapons equipped by models in that unit.
- **Foresight (Psychic)** (Datasheet): Each time this model makes an attack that targets a CHARACTER unit, you can re-roll the Hit roll.

**Keywords:** Infantry, Imperium, Epic Hero, Castellan Crowe, Character, Psyker, Grenades
