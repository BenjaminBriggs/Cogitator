...
|---|---|---|---|---|---|---|---|
| Taser lance | Melee | 4 | 4 | 7 | -2 | 2 | anti-walker 2+, lance, sustained hits 2 |
...
- **Dynamic Efficiency** (Datasheet): This unit is eligible to declare a charge in a turn in which it Advanced or Fell Back, and you can re-roll Desperate Escape tests taken for models in this unit.
- **Broad Spectrum Data-tether** (Datasheet): Each time you target this unit with a Stratagem, roll one D6: on a 5+, you gain 1CP.

**Keywords:** Walker, Dragoons With Taser Lances, Sydonian, Skitarii, Imperium, Smoke, Vehicle
