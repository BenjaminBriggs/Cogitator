...
- **Control Edict** (Datasheet): While this model is leading a unit, each time a model in that unit makes an attack, you can re-roll the Hit roll.
- **Servo-skull Uplink** (Datasheet): Once per battle, at the start of any phase, you can select one friendly Skitarii unit that is Battle-shocked and within 6" of this model. That unit is no longer Battle-shocked.

**Keywords:** Character, Skitarii, Infantry, Marshal, Imperium
...
**Leader:**
Can lead: Skitarii Vanguard, Skitarii Rangers
