...
|---|---|---|---|---|---|---|---|
| Impaler harpoon | 12 | 1 | 3 | 12 | -2 | 3 | anti-monster 2+, anti-vehicle 2+, impaled |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Slaughter blade | Melee | 5 | 3 | 12 | -3 | 3 | — |
| Twin slaughter blade | Melee | 5 | 3 | 12 | -3 | 3 | twin-linked |
...
- **Scuttling Gait** (Datasheet): Each time this unit Advances, do not make an Advance roll for it. Instead, until the end of the phase, add 6" to the Move characteristic of models in this unit.
- **Impaled** (Wargear profile): Each time this weapon scores a hit against an enemy MONSTER or VEHICLE unit, until the end of the turn, if the bearer selects that unit as a target of a charge, add 2 to Charge rolls made for the bearer

**Keywords:** Blood Slaughterer, Vehicle, Walker, Chaos, Khorne, Daemon
