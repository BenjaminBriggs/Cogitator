...
|---|---|---|---|---|---|---|---|
| Infernal cannon | 24 | 3 | 3 | 5 | -1 | 2 | rapid fire 1 |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Hellforged weapons – strike | Melee | 8 | 2 | 8 | -2 | 3 | — |
| Hellforged weapons – sweep | Melee | 16 | 2 | 6 | -1 | 1 | — |
...
- **Lord of Murder** (Datasheet): While this model is within 3" of one or more friendly World Eaters Infantry units, this model has the Lone Operative ability.
- **Devastating Assault** (Datasheet): Each time this model makes a Charge move, until the end of the turn, its melee weapons have the [DEVASTATING WOUNDS] ability.
- **Direct the Slaughter** (Datasheet): Once per battle round, one model from your army with this ability can use it when a friendly World Eaters unit within 12" of that model is targeted with a Stratagem. If it does, reduce the CP cost of that usage of that Stratagem by 1CP.
