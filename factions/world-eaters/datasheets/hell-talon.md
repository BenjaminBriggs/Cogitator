...
- **Bomb Rack** (Datasheet): Each time this model ends a Normal move, you can select one enemy unit it moved across during that move and roll six D6: for each 3+, that unit suffers 1 mortal wound.

**Keywords:** Vehicle, Vehicle, Chaos, Aircraft, Fly, Khorne, Hell Talon, Vehicle, Chaos, Aircraft, Fly, Khorne, Hell Talon, Hell Talon, Chaos, Aircraft, Fly, Khorne, Hell Talon, Vehicle, Chaos, Aircraft, Fly, Khorne, Hell Talon, Vehicle, Chaos, Aircraft, Fly, Khorne
