...
| Scorpion cannon | 36 | 15 | 3 | 5 | -1 | 2 | sustained hits 1 |
...
- **Super-heavy Walker** (Datasheet): Each time a model with this ability makes a Normal, Advance or Fall Back move, it can move over models (excluding TITANIC models) and terrain features that are 4" or less in height as if they were not there.
- **Runes of the Blood God** (Datasheet): This model has the Feel No Pain 4+ ability against mortal wounds and Psychic Attacks.

**Keywords:** Khorne, Vehicle, Titanic, Walker, Daemon, Greater Brass Scorpion, Chaos
