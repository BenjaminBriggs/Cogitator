...
|---|---|---|---|---|---|---|---|
| Bloody Twins | 24 | 6 | 2 | 5 | -1 | 2 | assault, pistol |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Sword of Asur | Melee | 6 | 2 | 6 | -3 | 3 | devastating wounds |
...
- **Tactical Acumen** (Datasheet): While this model is leading a unit, in your Shooting phase, after that unit has shot, it can make a Normal move of up to 6". If it does, until the end of the turn, that unit is not eligible to declare a charge.
- **Hand of Asuryan** (Datasheet): Once per battle, when this model is selected to shoot, it can use this ability. If it does, until the end of the phase, its Bloody Twins weapon has a Damage characteristic of 3 and the [ANTI-INFANTRY 5+] and [DEVASTATING WOUNDS] abilities.

**Keywords:** Grenades, Aeldari, Epic Hero, Character, Infantry, Phoenix Lord, Asurmen, Aspect Warrior
