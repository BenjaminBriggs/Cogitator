...
|---|---|---|---|---|---|---|---|
| The Wailing Doom – strike | Melee | 6 | 2 | 16 | -4 | D6+2 | — |
| The Wailing Doom – sweep | Melee | 12 | 2 | 8 | -2 | 2 | — |
...
- **Molten Form** (Datasheet): Each time an attack is allocated to this model, halve the Damage characteristic of that attack.
- **The Bloody-Handed (Aura)** (Datasheet): While a friendly AELDARI unit is within 6" of this model, add 1 to Advance and Charge rolls made for that unit.

**Keywords:** Epic Hero, Avatar of Khaine, Daemon, Aeldari, Character, Monster
