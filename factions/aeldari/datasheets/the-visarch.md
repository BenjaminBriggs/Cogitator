...
|---|---|---|---|---|---|---|---|
| Asu-var – quicksilver stance | Melee | 8 | 2 | 4 | -1 | 1 | sustained hits 2 |
| Asu-var – duellist stance | Melee | 6 | 2 | 5 | -2 | 2 | devastating wounds, precision |
| Asu-var – mythic stance | Melee | 4 | 2 | 3 | -4 | 3 | anti-epic hero 2+, precision |
...
- **Way of the Blade** (Datasheet): While this model is leadings unit, models in that unit have the Fights First ability.
- **Yvraine’s Champion** (Datasheet): While this model is leading a unit, other Character models attached to that unit have the Feel No Pain 4+ ability.
- **SERVANT OF THE WHISPERING GOD** (Fortification (левая колонка)): If your army includes THE VISARCH, it cannot include any Epic Hero units (excluding Ynnari units). If your army includes any EPIC HERO units (excluding YNNARI units), it cannot include THE VISARCH.

**Keywords:** Epic Hero, Aeldari, The Visarch, Character, Infantry
**Faction Keywords:** , Ynnari

**Unit Composition:**
- 1 Visarch – EPIC HERO

**Leader:**
Can lead: Ynnari Incubi, Ynnari Wyches, Ynnari Kabalite Warriors, Storm Guardians, Corsair Voidscarred, Corsair Voidreavers, Guardian Defenders
