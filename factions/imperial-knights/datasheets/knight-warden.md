...
- **Warden’s Duty (Bondsman)** (Datasheet): While a model is affected by this ability, weapons equipped by that model have the [SUSTAINED HITS 1] ability, and ranged weapons equipped by that model have the [IGNORES COVER] ability.
- **Thin Their Ranks** (Datasheet): Each time this model makes a ranged attack that targets an enemy unit (excluding MONSTERS and VEHICLES), that attack has the [DEVASTATING WOUNDS] ability.

**Keywords:** Towering, Questoris, Character, Imperium, Titanic, Knight Warden, Vehicle, Walker
