...
| Thermal cannon | 24 | 2D3 | 3 | 12 | -4 | D6 | blast, melta 6 |
...
- **Errant’s Duty (Bondsman)** (Datasheet): While a model is affected by this ability, you can re-roll Advance rolls made for that model and ranged weapons equipped by that model have the [ASSAULT] ability.
- **Aggressive Assault** (Datasheet): Each time this model makes a ranged attack that targets the closest eligible target, add 1 to the Hit roll.

**Keywords:** Walker, Imperium, Character, Questoris, Towering, Titanic, Vehicle, Knight Errant
