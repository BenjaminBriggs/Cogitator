...
| Helios defence missiles | 48 | 3 | 3 | 10 | -2 | D6 | anti-fly 2+, heavy |
| Lascannon | 48 | 1 | 3 | 12 | -3 | D6+1 | — |
| Twin magna lascannon | 72 | D6 | 3 | 18 | -4 | D6+6 | blast, twin-linked |
...
- **Bastion of Firepower** (Datasheet): Each time this model Remains Stationary, until the end of the turn, ranged weapons equipped by this model have the [LETHAL HITS] ability.

**Keywords:** Imperium, Knight Porphyrion, Acastus, Towering, Titanic, Walker, Vehicle
...
**Wargear Options:**
- This model’s 2 Acastus autocannons can be replaced with one of the following:- 2 lascannons
