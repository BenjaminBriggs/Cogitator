...
|---|---|---|---|---|---|---|---|
| The Slayer Sword | Melee | 6 | 2 | 6 | -2 | 3 | devastating wounds, precision |
...
- **Lord of Decapitations** (Datasheet): While this model is leading a unit, melee weapons equipped by models in that unit have the [DEVASTATING WOUNDS] ability.
- **Skulls for Khorne** (Datasheet): Each time this model makes an attack that targets a Character unit, you can re-roll the Hit roll and you can re-roll the Wound roll. Each time this model destroys an enemy Character unit, you gain 1CP.

**Keywords:** Khorne, Skulltaker, Daemon, Epic Hero, Infantry, Character, Chaos
