...
**Invulnerable Save (TRAITOR ENFORCER: 5)**
** Traitor Enforcer model only.*
**Invulnerable Save (TRAITOR OGRYN: -)**
...
- [LETHAL HITS]
- [SUSTAINED HITS 1]
- **Brutal Example** (Datasheet): Once per turn, while this unit is leading a unit and contains a TRAITOR ENFORCER model, you can target that unit with the Fire Overwatch Stratagem for 0CP, and can do so even if you have already targeted a different unit from your army with that Stratagem this turn. Each time you use this ability, one Bodyguard model in that unit is destroyed.
- **Mutated Bodyguard** (Datasheet): While this unit contains a Traitor Ogryn model, CHARACTER models in this unit have the Feel No Pain 4+ ability.

**Keywords:** Infantry, Chaos, Grenades, Damned, Shadow Legion, Shadow Legion, Traitor Enforcer, Undivided, Infantry, Chaos, Grenades, Character, Traitor Enforcer, Undivided, Shadow Legion, Undivided, Traitor Enforcer, Grenades, Character, Damned, Grenades, Chaos, Infantry, Shadow Legion, Undivided, Traitor Enforcer, Character, Damned, Chaos, Infantry, Shadow Legion, Undivided, Traitor Enforcer, Character, Damned, Grenades, Chaos, Infantry, Shadow Legion, Undivided, Traitor Enforcer, Character, Damned, Grenades, Chaos, Infantry, Damned, Character
...
**Leader:**
Can lead: Traitor Guardsmen Squad
