...
|---|---|---|---|---|---|---|---|
| Autogun | 24 | 1 | 3 | 3 | 0 | 1 | rapid fire 1 |
| Shotgun | 12 | 2 | 3 | 4 | 0 | 1 | assault |
| Lasgun | 24 | 1 | 3 | 3 | 0 | 1 | rapid fire 1 |
...
- [LETHAL HITS]
- [SUSTAINED HITS 1]
- **Brutal Example** (Datasheet): While this model is leading a unit, you can target that unit with the Insane Bravery Stratagem for 0CP, and can do so even if another unit from your army has already been targeted with that Stratagem this phase. Each time you use this ability, one Bodyguard model in that unit is destroyed.
- **Enforcer** (Datasheet): This model’s unit is eligible to declare a charge in a turn in which it Fell Back.

**Keywords:** Damned, Damned, Grenades, Character, Renegade Enforcer, Undivided, Shadow Legion, Infantry, Character, Renegade Enforcer, Undivided, Shadow Legion, Grenades, Damned, Chaos, Infantry, Shadow Legion, Undivided, Renegade Enforcer, Character, Shadow Legion, Infantry, Renegade Enforcer, Chaos, Chaos, Undivided, Infantry, Chaos, Damned, Grenades, Character, Renegade Enforcer, Undivided, Shadow Legion, Infantry, Grenades, Damned, Chaos, Infantry, Shadow Legion, Undivided, Renegade Enforcer, Character, Grenades, Damned, Chaos, Character, Grenades
...
**Wargear Options:**
- This model’s Enforcer pistol can be replaced with one of the following:- 1 autogun
- 1 lasgun
- 1 shotgun
- This model’s Enforcer melee weapon can be replaced with one of the following:- 1 power fist
- 1 power weapon

**Leader:**
Can lead: Renegade Heavy Weapons Squad, Traitor Guardsmen Squad
