...
|---|---|---|---|---|---|---|---|
| Putrid appendages | Melee | 6 | 4 | 6 | -1 | 2 | devastating wounds |
...
- **Grotesque Regeneration** (Datasheet): At the end of each phase, if a Beasts of Nurgle model in this unit has lost any wounds but is not destroyed, that model regains all of its lost wounds.

**Keywords:** Chaos, Daemon, Beast, Beasts of Nurgle, Shadow Legion, Nurgle
