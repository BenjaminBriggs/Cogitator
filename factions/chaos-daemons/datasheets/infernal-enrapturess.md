...
|---|---|---|---|---|---|---|---|
| Heartstring lyre – cacophonous melody | 18 | 6 | 3 | 6 | 0 | 1 | assault |
| Heartstring lyre – euphonic blast | 24 | 1 | 3 | 12 | -3 | D6+1 | assault |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Ravaging claws | Melee | 5 | 2 | 4 | -1 | 1 | devastating wounds |
...
- **Harmonic Alignment** (Datasheet): While this model is leading a unit, in your Command phase, you can return D3 destroyed Bodyguard models to that unit.
- **Discordant Disruption (Aura)** (Datasheet): While an enemy PSYKER unit is within 12" of this model, Psychic weapons equipped by models in that unit have the [HAZARDOUS] ability.

**Keywords:** Slaanesh, Shadow Legion, Infernal Enrapturess, Infantry, Character, Chaos, Daemon
