...
| Screamer bites | Melee | 6 | 3 | 6 | -2 | 2 | anti-monster 4+, anti-vehicle 4+, extra attacks |
...
- **Fateskimmer** (Datasheet): While this model is leading a unit, melee weapons equipped by models in that unit have the [LETHAL HITS] ability.
- **Rider of the Immaterial Winds** (Datasheet): Once per battle, at the end of your opponent’s turn, if this model’s unit is not within Engagement Range of one or more enemy units, you can remove that unit from the battlefield and place it into Strategic Reserves.

**Keywords:** Fateskimmer, Shadow Legion, Mounted, Character, Psyker, Fly, Daemon, Tzeentch, Chaos
