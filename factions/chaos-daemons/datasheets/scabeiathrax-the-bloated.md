...
|---|---|---|---|---|---|---|---|
| Blade of decay – Strike | Melee | 7 | 2 | 9 | -2 | D6 | lethal hits |
| Blade of decay – Sweep | Melee | 14 | 2 | 7 | -1 | 1 | lethal hits |
...
- **Emissary of the Plague God (Aura)** (Datasheet): While a friendly Nurgle Legiones Daemonica unit is within 6" of this model, you can re-roll Battle-shock tests taken for that unit.
