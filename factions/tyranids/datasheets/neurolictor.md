...
|---|---|---|---|---|---|---|---|
| Piercing claws and talons | Melee | 6 | 2 | 6 | -2 | 1 | precision |
...
- **Neural Disruption** (Datasheet): In your Command phase, select one enemy unit within 12" of this model. That unit must take a Battle-shock test.
- **Psychological Saboteur (Aura)** (Datasheet): While an enemy unit is within 12" of this model, if that unit is Battle-shocked:
...
**Keywords:** Synapse, Infantry, Great Devourer, Vanguard Invader, Neurolictor
