...
- **Auspex Surveyor** (Datasheet): Each time this model has shot, select one enemy unit hit by one or more of those attacks. Until the end of the phase, that unit cannot have the Benefit of Cover.
- **One Shot** (Wargear profile): The bearer can only shoot with this weapon once per battle.

**Keywords:** Vehicle, Squadron, Smoke, Imperium, Salamander Command Vehicle
