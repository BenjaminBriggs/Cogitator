...
*Catachan officers surround themselves with the most battle-hardened veterans, for only they can be trusted to bear the regiment’s battle standards to war. Catachan Command Squads fight with the same aggression as their fellow soldiers, putting themselves in harm’s way in order to inspire their troops.*
...
| Boltgun | 24 | 1 | 4 | 4 | 0 | 1 | rapid fire 1 |
...
| Plasma gun – supercharge | 24 | 1 | 4 | 8 | -3 | 2 | hazardous, rapid fire 1 |
| Plasma pistol – standard | 12 | 1 | 4 | 7 | -2 | 1 | pistol |
| Plasma pistol – supercharge | 12 | 1 | 4 | 8 | -3 | 2 | hazardous, pistol |
| Sniper rifle | 36 | 1 | 4 | 4 | -2 | 2 | heavy, precision |
...
**Abilities:**
- **Leader** (Core): LEADERMighty heroes fight at the forefront of battle.
...
- **Scouts** (Core): SCOUTSScouts form the vanguard of many armies. Unnoticed by the enemy, they range ahead of the main force.
...
M+3"Add 3" to the Move characteristic of models in this unit.

Fix Bayonets!

WS+1Improve the Weapon Skill characteristic of melee weapons equipped by models in this unit by 1.

Take Aim!

BS+1Improve the Ballistic Skill characteristic of ranged weapons equipped by models in this unit by 1.

First Rank, Fire! Second Rank, Fire!

A+1Improve the Attacks characteristic of Rapid Fire weapons equipped by models in this unit by 1.

Take Cover!

SV+1Improve the Save characteristic of models in this unit by 1 (this cannot improve a model’s Save to better than 3+).

Duty and Honour!

LD+1OC+1Improve the Leadership and Objective Control characteristics of models in this unit by 1.
- **Gung-ho Command** (Datasheet): While this unit contains an OFFICER, ranged weapons equipped by models in this unit have the [ASSAULT] ability.
- **Master Vox** (Wargear): Each time the OFFICER in the bearer’s unit issues an Order, it can issue it to an eligible unit up to 24" away.
- **Medi-pack** (Wargear): At the start of your Command phase, if the bearer’s unit is below its Starting Strength, you can return up to D3 destroyed PLATOON models (excluding CHARACTERS) to this unit.
- **Regimental Standard** (Wargear): Add 1 to the Objective Control characteristic of models in the bearer’s unit.
- **ORDERS** (Special (правая колонка)): This unit’s OFFICER can issue 1 Order to a Regiment unit.

**Keywords:** Platoon, Catachan, Officer, Character, Command Squad, Imperium, Infantry, Grenades
...
**Wargear Options:**
- Any number of Veteran Guardsmen can each have their lasgun replaced with one of the following*:- 1 flamer
- 1 grenade launcher
- 1 heavy flamer
- 1 meltagun
- 1 plasma gun
...
- The Catachan Commander’s laspistol can be replaced with one of the following:- 1 bolt pistol
- 1 plasma pistol
- The Catachan Commander can be equipped with one of the following:- 1 boltgun
- 1 chainsword
- 1 power fist
- 1 power weapon

**Leader:**
Can lead: Catachan Jungle Fighters
