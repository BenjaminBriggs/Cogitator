...
| Stygies laser destroyer | 72 | 2 | 4 | 14 | -4 | D6+3 | heavy |
...
- **Tank Hunter** (Datasheet): Each time this model makes a ranged attack that targets a VEHICLE unit, add 1 to the Wound roll.
- **One Shot** (Wargear profile): The bearer can only shoot with this weapon once per battle.

**Keywords:** Smoke, Squadron, Imperium, Vehicle, Stygies Destroyer Tank Hunter
