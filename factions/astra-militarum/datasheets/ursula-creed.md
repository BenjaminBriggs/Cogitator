...
|---|---|---|---|---|---|---|---|
| Duty and Vengeance | 12 | 4 | 3 | 5 | -2 | 1 | pistol |
...
- **Lord Castellan** (Datasheet): While this model is leading a unit, that unit can be affected by up to two different Orders at the same time.
- **Tactical Genius** (Datasheet): Once per battle round, one friendly Regiment unit within 12" of this model can be targeted with a Stratagem. If it does, reduce the CP cost of that use of that Stratagem by 1CP.
- **ORDERS** (Special (правая колонка)): This OFFICER can issue up to 3 Orders to Regiment units.

**Keywords:** Ursula Creed, Infantry, Character, Epic Hero, Imperium, Officer
...
**Leader:**
Can lead: Kasrkin, Cadian Shock Troops
