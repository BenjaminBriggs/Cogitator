...
**Default Wargear:**
**This model is equipped with:** Mechanicus pistol; Enginseer axe; servo-arm.
...
| Servo-arm | Melee | 1 | 4 | 6 | -2 | 2 | extra attacks |
...
- **Enginseer** (Datasheet): While this model is within 3" of one or more friendly Astra Militarum Vehicle units, this model has the Lone Operative ability.
- **Omnissiah’s Blessing** (Datasheet): In your Command phase, select one friendly Astra Militarum Vehicle model within 3" of this model. That VEHICLE model regains up to D3 lost wounds and, until the start of your next Command phase, that VEHICLE model has a 4+ invulnerable save. Each model can only be selected for this ability once per turn.
- **Vengeance for the Omnissiah** (Datasheet): If a friendly Astra Militarum Vehicle model is destroyed within 12" of this model, until the end of the battle, this model’s Enginseer axe has an Attacks characteristic of 6.

**Keywords:** Tech-Priest Enginseer, Imperium, Character, Infantry
...
**Leader:**
Can lead: Krieg Combat Engineers, Kasrkin, Death Korps Of Krieg, Catachan Jungle Fighters, Cadian Shock Troops
