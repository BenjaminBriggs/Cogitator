...
|---|---|---|---|---|---|---|---|
| Griffon heavy mortar | 48 | D6 | 4 | 7 | -1 | 2 | blast, indirect fire |
...
- **Suppression Bombardment** (Datasheet): In your Shooting phase, after this model has shot, select one enemy unit (excluding MONSTER and VEHICLE units) hit by one or more of those attacks made with this model’s Griffon heavy mortar. Until the start of your next turn, that enemy unit is suppressed. While a unit is suppressed, each time a model in that unit makes an attack, subtract 1 from the Hit roll.

**Keywords:** Smoke, Squadron, Imperium, Vehicle, Artillery, Griffon Mortar Carrier
...
- This model can each be equipped with one of the following:- 1 heavy stubber
- 1 storm bolter
