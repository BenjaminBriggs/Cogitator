...
|---|---|---|---|---|---|---|---|
| Mace of the righteous | Melee | 4 | 3 | 5 | -2 | 2 | — |
...
- **Executioner of Heretics (Aura)** (Datasheet): While an enemy unit is within 6" of this model, worsen the Leadership characteristic of models in that unit by 1.
- **Unflinching Determination** (Datasheet): While this model is leading a unit, add 1 to the Objective Control characteristic of models in that unit.

**Keywords:** Character, Infantry, Dogmata, Imperium, Grenades
...
**Leader:**
Can lead: Retributor Squad, Celestian Sacresants, Battle Sisters Squad, Celestian Insidiants, Dominion Squad, Crusaders
