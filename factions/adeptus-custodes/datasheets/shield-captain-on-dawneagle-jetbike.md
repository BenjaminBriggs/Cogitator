...
|---|---|---|---|---|---|---|---|
| Vertus hurricane bolter | 18 | 3 | 2 | 4 | -1 | 2 | rapid fire 3, twin-linked |
| Salvo launcher | 24 | 1 | 2 | 10 | -3 | D6+1 | twin-linked |
...
- **Sweeping Advance** (Datasheet): Once per battle, at the end of the Fight phase, if this model’s unit has fought this phase, if it is within Engagement Range of one or more enemy units, it can make a Fall Back move or, if it is not within Engagement Range of one or more enemy units, it can make a Normal move
- **Strategic Mastery** (Datasheet): Once per battle round, you can select one model from your army with this ability and target that model’s unit with a Stratagem. If it does, reduce the CP cost of that use of that Stratagem by 1CP.

**Keywords:** Character, Fly, Imperium, Dawneagle Jetbike, Shield-Captain, Mounted
