...
|---|---|---|---|---|---|---|---|
| Perdition Pistol | 6 | 1 | 2 | 9 | -4 | D6 | melta 2, pistol, sustained hits d3 |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| The Axe Mortalis | Melee | 8 | 2 | 8 | -3 | 2 | lethal hits |
...
- **Warden of the Imperium Nihilus** (Datasheet): While this model is leading a unit, add 1 to Advance and Charge rolls made for that unit and each time a model in that unit makes an attack, add 1 to the Hit roll.
- **Death Mask of Sanguinius** (Datasheet): At the start of the Fight phase, each enemy unit within 6" of this model must take a Battle-shock test, subtracting 1 from that test when they do.

**Keywords:** Commander Dante, Chapter Master, Tacticus, Imperium, Grenades, Fly, Epic Hero, Character, Infantry, Jump Pack
...
**Leader:**
Can lead: Sanguinary Guard, Wolf Guard, Talonstrike Kill Team, Vanguard Veteran Squad, Assault Intercessors With Jump Packs, Assault Squad with Jump Packs, Vanguard Veteran Squad With Jump Packs, Skyclaws
