...
**Default Wargear:**
**This model is equipped with:** Arcus multi-launcher; heavy bolter, armoured tracks.

**Ranged Weapons**
| Name | Range | A | BS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Arcus multi-launcher | 48 | 2D6 | 3 | 6 | 0 | 2 | indirect fire |
...
- **Specialised Weapon System** (Datasheet): Each time this model makes an attack that targets the enemy unit you selected for the Oath of Moment ability that attack has the [IGNORES COVER] ability and can ignore the penalty to their Hit rolls when making attacks with Indirect Fire weapons against targets that are not visible to them.
- **One Shot** (Wargear profile): The bearer can only shoot with this weapon once per battle.

**Keywords:** Imperium, Smoke, Sicaran Arcus, Vehicle
