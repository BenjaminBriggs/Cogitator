...
- **Priority Target Acquisition** (Datasheet): Each time this model makes an attack with its twin las-talon that targets the closest eligible MONSTER or VEHICLE unit, add 1 to the Hit roll.

**Keywords:** Gladiator Valiant, Vehicle, Imperium, Smoke
