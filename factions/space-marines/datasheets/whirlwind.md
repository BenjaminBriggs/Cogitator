...
**Default Wargear:**
**This model is equipped with:** Whirlwind vengeance launcher; armoured tracks.
...
- **Pinning Bombardment** (Datasheet): In your Shooting phase, after this model has shot, if one or more of those attacks made with its Whirlwind vengeance launcher scored a hit against an enemy INFANTRY unit, that unit must take a Battle-shock test.
