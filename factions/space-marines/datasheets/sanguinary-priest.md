...
**Default Wargear:**
**This model is equipped with:** absolvor bolt pistol; Astartes chainsword.
...
- **Sanguinary Priest** (Datasheet): While this model is leading a unit, models in that unit have the Feel No Pain 5+ ability.
- **Blood Chalice** (Datasheet): While this model is leading a unit, improve the Armour Penetration characteristic of melee weapons equipped by models in that unit by 1.

**Keywords:** Character, Infantry, Sanguinary Priest, Grenades, Imperium, Tacticus
...
**Leader:**
Can lead: Deathwatch Veterans, Intercessor Squad, Assault Squad, Sternguard Veteran Squad, Tactical Squad, Decimus Kill Team, Assault Intercessor Squad, Fortis Kill Team, Desolation Squad, Long Fangs, Devastator Squad, Vanguard Veteran Squad, Wolf Guard, Sternguard Veteran Squad, Sword Brethren Squad, Bladeguard Veteran Squad, Crusader Squad, Hellblaster Squad, Crusader Squad (Legendary), Infernus Squad, Inner Circle Companions
