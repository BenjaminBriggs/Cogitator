...
**Default Wargear:**
**This model is equipped with:** bolt pistol; crushing teeth and jaws; Wolf claws.
...
|---|---|---|---|---|---|---|---|
| Crushing teeth and claws | Melee | 3 | 4 | 5 | -1 | 1 | extra attacks |
| Wolf claws | Melee | 8 | 2 | 5 | -2 | 1 | twin-linked |
...
- **Born of Wolves** (Datasheet): While this model is leading a unit, melee weapons equipped by models in that unit have the [SUSTAINED HITS 1] ability.
- **Alpha Predator** (Datasheet): Each time this model ends a Charge move, select one enemy unit within Engagement Range of it and roll one D6: on a 2-3, that enemy unit suffers D3 mortal wounds; on a 4-5, that enemy unit suffers 3 mortal wounds; on a 6, that enemy units suffers D3+3 mortal wounds.

**Keywords:** Canis Wolfborn, Imperium, Character, Epic Hero, Mounted
...
**Leader:**
Can lead: Fenrisian Wolves, Thunderwolf Cavalry
