...
**Default Wargear:**
**This model is equipped with:** bolt pistol; Frostfang.
...
|---|---|---|---|---|---|---|---|
| Frostfang | Melee | 8 | 2 | 6 | -3 | 2 | sustained hits 1 |
...
- **War Howl** (Datasheet): While this model is leading a Blood Claws unit, each time a model in that unit makes a melee attack, you can re-roll the Wound roll. While this model is leading a Wolf Guard Headtakers unit, that unit is eligible to declare a charge in a turn in which it Advanced.
- **Battle-lust** (Datasheet): Each time this model ends a Charge move, until the end of the turn, add 2 to the Attacks characteristic of this model’s Frostfang weapon.

**Keywords:** Infantry, Character, Epic Hero, Ragnar Blackmane, Captain, Tacticus, Grenades, Imperium
...
**Leader:**
Can lead: Wolf Guard Headtakers, Blood Claws
