...
- **Self Repair** (Datasheet): At the end of your Command phase, this model regains 1 lost wound.
- **One Shot** (Wargear profile): The bearer can only shoot with this weapon once per battle.

**Keywords:** Rhino, Vehicle, Smoke, Transport, Dedicated Transport, Imperium
