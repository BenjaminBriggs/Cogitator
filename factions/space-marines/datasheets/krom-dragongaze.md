...
**Default Wargear:**
**This model is equipped with:** bolt pistol; Wyrmclaw.
...
|---|---|---|---|---|---|---|---|
| Wyrmclaw | Melee | 6 | 2 | 7 | -2 | 2 | lethal hits |
...
- **Refuse to Accept Defeat** (Datasheet): While this model is leading a unit, each time a model in that unit makes an attack, add 1 to the Hit roll if that unit is below its Starting Strength, and add 1 to the Wound roll as well if that unit is Below Half-strength.
- **The Fierce Eye** (Datasheet): In your Shooting phase, you can select one enemy INFANTRY unit within 12" of and visible to this model. That enemy unit must take a Battle-shock test.

**Keywords:** Captain, Imperium, Grenades, Character, Infantry, Epic Hero, Krom Dragongaze
...
**Leader:**
Can lead: Wolf Guard Battle Leader, Grey Hunters, Wolf Guard Headtakers, Wolf Guard Terminators, Wolf Guard, Blood Claws
