...
- **Narthecium** (Datasheet): While this model is leading a unit, in your Command phase, you can return 1 destroyed model (excluding CHARACTER models) to that unit.
- **Gene-seed Recovery** (Datasheet): When this model’s Bodyguard unit is destroyed, roll one D6: on a 2+, you gain 1CP

**Keywords:** Tacticus, Apothecary, Infantry, Character, Grenades, Imperium
...
**Leader:**
Can lead: Decimus Kill Team, Desolation Squad, Assault Intercessor Squad, Crusader Squad (Legendary), Assault Squad, Devastator Squad, Intercessor Squad, Crusader Squad, Long Fangs, Sword Brethren Squad, Inner Circle Companions, Tactical Squad, Infernus Squad, Vanguard Veteran Squad, Hellblaster Squad, Sternguard Veteran Squad, Wolf Guard, Sternguard Veteran Squad, Fortis Kill Team, Deathwatch Veterans
