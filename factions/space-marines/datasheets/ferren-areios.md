...
**Default Wargear:**
**This model is equipped with:** heavy bolt pistol; relic thunder hammer.
...
|---|---|---|---|---|---|---|---|
| Relic thunder hammer | Melee | 5 | 2 | 8 | -2 | 3 | devastating wounds |
...
- **Master of Rites** (Datasheet): In your Command phase, select one of the following to apply to this model’s unit until the end of the turn:
...
- **Unrelenting and Uncompromising** (Datasheet): While this model is leading a unit, each time a model in that unit makes an attack, you can ignore any or all modifiers to that attack’s Ballistic Skill or Weapon Skill characteristics and/or all modifiers to the Hit roll.

**Keywords:** Infantry, Imperium, Character, Grenades, Epic Hero, Tacticus, Captain, Ferren Areios
...
**Leader:**
Can lead: Decimus Kill Team, Wolf Guard, Assault Squad, Command Squad, Company Heroes, Infernus Squad, Intercessor Squad, Crusader Squad, Crusader Squad (Legendary), Deathwatch Veterans, Sternguard Veteran Squad, Sternguard Veteran Squad, Tactical Squad, Inner Circle Companions, Vanguard Veteran Squad, Assault Intercessor Squad, Bladeguard Veteran Squad, Victrix Honour Guard, Fortis Kill Team, Sword Brethren Squad, Hellblaster Squad
