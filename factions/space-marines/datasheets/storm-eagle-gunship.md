...
**Keywords:** Fly, Transport, Imperium, Storm Eagle Gunship, Aircraft, Ravenwing, Vehicle
...
**Transport:**
This model has a transport capacity of 22 ADEPTUS ASTARTES INFANTRY models and 1 Dreadnought model. Each Jump Pack, Wulfen, Gravis, Terminator or Possessed model takes up the space of 2 models and each Centurion or Obliterator model takes up the space of 3 models.
