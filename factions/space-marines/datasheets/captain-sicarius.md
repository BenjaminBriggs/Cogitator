...
**Default Wargear:**
**This model is equipped with:** artisan plasma pistol; Talassarian Tempest Blade.

**Ranged Weapons**
| Name | Range | A | BS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Artisan plasma pistol | 12 | 1 | 2 | 8 | -3 | 2 | pistol |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Talassarian Tempest Blade | Melee | 6 | 2 | 5 | -2 | 2 | lethal hits |
...
- **Lead From the Front** (Datasheet): While this model is leading a unit, models in that unit have the Scouts 6" ability and ranged weapons equipped by models in that unit have the [ASSAULT] ability.
- **Lightning Assault** (Datasheet): Once per turn, when an enemy unit ends a Normal, Advance or Fall Back move within 9" of this model, if this model’s unit is not within Engagement Range of one or more enemy units, it can make a Normal move of up to 6".

**Keywords:** Imperium, Infantry, Character, Epic Hero, Tacticus, Captain, Sicarius
**Faction Keywords:** Ultramarines, Adeptus Astartes

**Unit Composition:**
- 1 Captain Sicarius – EPIC HERO

**Leader:**
Can lead: Deathwatch Veterans, Bladeguard Veteran Squad, Company Heroes, Victrix Honour Guard, Vanguard Veteran Squad, Wolf Guard, Crusader Squad (Legendary), Tactical Squad, Sternguard Veteran Squad, Assault Intercessor Squad, Command Squad, Assault Squad, Sternguard Veteran Squad, Inner Circle Companions
