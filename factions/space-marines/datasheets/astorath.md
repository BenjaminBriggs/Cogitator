...
**Default Wargear:**
**This model is equipped with:** the Executioner’s Axe.

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| The Executioner’s Axe | Melee | 6 | 2 | 7 | -3 | 2 | devastating wounds, Precision |
...
- **Redeemer of the Lost** (Datasheet): While this model is leading a unit, each time a model in that unit is destroyed by a melee attack, if that model has not fought this phase, roll one D6. On a 4+, do not remove it from play; that destroyed model can fight after the attacking model’s unit has finished making its attacks, and is then removed from play.
- **Mass of Doom** (Datasheet): Each time this model’s unit makes a Charge move, until the end of the turn, melee weapons equipped by models in that unit have the [DEVASTATING WOUNDS] ability.

**Keywords:** Imperium, Chaplain, Astorath, Fly, Tacticus, Infantry, Character, Epic Hero, Jump Pack
...
**Leader:**
Can lead: Death Company Marines With Jump Packs, Death Company Marines with Boltguns and Jump Packs
