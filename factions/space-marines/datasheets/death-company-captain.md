...
- **Forlorn Hero** (Datasheet): While this model is leading a unit, unless that unit starts the battle embarked within a Transport, models in that unit have the Scouts 6" ability.
...
**Leader:**
Can lead: Death Company Marines, Death Company Marines with Bolt Rifles
