...
- **Psychic Hood** (Datasheet): While this model is leading a unit, models in that unit have the Feel No Pain 4+ ability against Psychic Attacks.
- **Veil of Time (Psychic)** (Datasheet): While this model is leading a unit, weapons equipped by models in that unit have the [SUSTAINED HITS 1] ability.

**Keywords:** Psyker, Imperium, Terminator, Librarian, Deathwing, Infantry, Character
...
**Leader:**
Can lead: Terminator Squad, Deathwing Terminator Squad, Deathwing Knights, Deathwatch Terminator Squad, Deathwing Command Squad, Terminator Assault Squad, Terminator Squad, Relic Terminator Squad
