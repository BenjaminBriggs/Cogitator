...
*Bladeguard Ancients bear the honour of carrying their Chapter’s precious standards into battle. The most revered of these incorporate the remains of fallen heroes of the Chapter; in their presence, battle-brothers are inspired to emulate the legendary deeds of these paragons of old.*
...
**Default Wargear:**
**This model is equipped with:** heavy bolt pistol; close combat weapon.
...
- **Deeds of Heroism** (Datasheet): Once per battle, when this model is selected to fight, it can use this ability. If it does, until the end of the phase, add 1 to the Attacks characteristic of melee weapons equipped by models in this model’s unit.

**Keywords:** Character, Deathwing, Infantry, Grenades, Imperium, Tacticus, Ancient, Bladeguard Ancient
...
**Leader:**
Can lead: Bladeguard Veteran Squad
