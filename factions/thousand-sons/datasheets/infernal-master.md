...
| Fires of the Abyss – witchfire | 18 | D6 | N/A | 6 | -2 | 1 | psychic, torrent |
| Fires of the Abyss – focused witchfire | 18 | 2D6 | N/A | 6 | -2 | 1 | hazardous, psychic, torrent |
...
- **Malefic Maelstrom (Psychic)** (Datasheet): While this model is leading a unit, weapons equipped by models in that unit have the [SUSTAINED HITS 1] ability.
- **Glimpse of Eternity (Psychic)** (Datasheet): Once per turn, you can change the result of one Hit roll, one Wound roll or one saving throw made for this model to an unmodified 6.

**Keywords:** Infernal Master, Tzeentch, Chaos, Psyker, Grenades, Character, Infantry
