...
**Invulnerable Save (GHAZGHKULL THRAKA: 4)**
**Invulnerable Save (MAKARI: 2)**
...
- **Prophet of Da Great Waaagh!** (Datasheet): While this unit is leading a unit, each time a model in that unit makes a melee attack, add 1 to the Hit roll and add 1 to the Wound roll and if the Waaagh! is active for your army, a Critical Hit is scored on a successful unmodified Hit roll of 5+.
- **Ghazghkull’s Waaagh! Banner (Aura)** (Datasheet): While a friendly ORKS unit is within 12" of Makari, if the Waaagh! is active for your army, melee weapons equipped by models in that unit have the [LETHAL HITS] ability.
- **SUPREME COMMANDER** (Special (правая колонка)): If this unit is in your army, its Ghazghkull Thraka model must be your Warlord.

**Keywords:** Character, Epic Hero, Warboss, Infantry, Ghazghkull Thraka
...
**Leader:**
Can lead: Breaka Boyz, Nobz, Meganobz, Boyz
