...
|---|---|---|---|---|---|---|---|
| Slugga | 12 | 1 | 5 | 4 | -1 | 1 | Anti-Monster 4+, pistol |
...
- **Super Runts** (Datasheet): While this model is leading a unit: 
...
- **Special Dose** (Datasheet): While the Waaagh! is active for your army, add 6" to the Move characteristic of models in this model’s unit.

**Keywords:** Zodgrod Wortsnagga, Infantry, Character, Epic Hero
