...
## Deadly Demise
DEADLY DEMISEFrom detonating ammo stores to corrosive innards or frenzied death throes, some targets are deadly even in defeat.
...
## Deep Strike
DEEP STRIKESome units make their way to battle via tunnelling, teleportation, high-altitude descent or other extraordinary means that allow them to appear suddenly in the thick of the fighting.
...
## Feel No Pain
FEEL NO PAINSome warriors refuse to be laid low, even by what should be fatal wounds.
...
## Fights First
FIGHTS FIRSTSome warriors attack with blinding speed, landing their blows before their foes can react.
...
## Firing Deck
FIRING DECKSome transports have firing hatches, ports or platforms from which embarked passengers can shoot.
...
## Hover
HOVERSome aircraft can use vectored thrusters or anti-grav technology to hover over the battlefield, the better to hunt their prey or deploy embarked troops.
...
## Infiltrators
INFILTRATORSMany armies employ reconnaissance units who can sit concealed, waiting for the right moment to strike.
...
## Leader
LEADERMighty heroes fight at the forefront of battle.
...
## Lone Operative
LONE OPERATIVEAssassins and other covert agents are difficult to track and pinpoint in the swirling maelstrom of battle.
...
## Scouts
SCOUTSScouts form the vanguard of many armies. Unnoticed by the enemy, they range ahead of the main force.
...
## Stealth
STEALTHSome warriors are masters of disguise and concealment.
