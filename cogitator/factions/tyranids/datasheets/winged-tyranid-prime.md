...
- **Alpha Warrior** (Datasheet): While this model is leading a unit, weapons equipped by models in that unit have the [SUSTAINED HITS 1] ability.
- **Death Blow** (Datasheet): If this model is destroyed by a melee attack, if it has not fought this phase, roll one D6: on a 4+, do not remove it from play. The destroyed model can fight after the attacking model’s unit has finished making its attacks, and is then removed from play.

**Keywords:** Character, Infantry, Fly, Great Devourer, Synapse, Vanguard Invader, Winged Tyranid Prime
...
**Leader:**
Can lead: Gargoyles, Tyranid Warriors With Melee Bio-weapons, Tyranid Warriors With Ranged Bio-weapons
