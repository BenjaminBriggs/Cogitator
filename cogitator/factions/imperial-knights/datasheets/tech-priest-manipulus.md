...
- **Galvanic Field** (Datasheet): While this model is leading a unit, weapons equipped by models in that unit have the [LETHAL HITS] ability.
- **Defend the Divine Work** (Datasheet): Once per battle, at the start of any phase, this model can use this ability. If it does, until the end of the phase, all models in this model’s unit have a 4+ invulnerable save.

**Keywords:** Manipulus, Imperium, Infantry, Character, Cult Mechanicus, Tech-Priest
