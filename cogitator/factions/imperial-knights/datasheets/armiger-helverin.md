...
|---|---|---|---|---|---|---|---|
| Armiger autocannon | 48 | 4 | 3 | 9 | -1 | 3 | — |
...
- **Suppression Protocols** (Datasheet): In your Shooting phase, after this model has shot, select one enemy unit (excluding MONSTERS and VEHICLES) hit by one or more of those attacks made with an Armiger autocannon. Until the start of your next turn, that enemy unit is suppressed. While a unit is suppressed, each time a model in that unit makes an attack, subtract 1 from the Hit roll.

**Keywords:** Walker, Vehicle, Imperium, Armiger, Helverin
