...
**Default Wargear:**
**Canis Rex is equipped with:** las-impulsor; Questoris multi-laser; Freedom’s Hand.

**Ranged Weapons**
| Name | Range | A | BS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Las-impulsor – high intensity | 24 | D6 | 2 | 14 | -3 | 4 | blast, sustained hits 1 |
| Las-impulsor – low intensity | 36 | 2D6 | 2 | 7 | -1 | 2 | blast, sustained hits 1 |
| Questoris multi-laser | 36 | 4 | 2 | 6 | 0 | 1 | sustained hits 1 |
...
- **Legendary Freeblade** (Datasheet): Once per turn, when you target this model with a stratagem, you may reduce the CP cost of that use of that stratagem by 1CP.
- **Chainbreaker** (Datasheet): Once per battle, at the start of any phase, you can select one friendly IMPERIUM unit that is Battle-shocked and within 12" of this model. That unit is no longer Battle-shocked.

**Keywords:** Vehicle, Walker, Towering, Questoris, Character, Epic Hero, Imperium, Canis Rex, Titanic
