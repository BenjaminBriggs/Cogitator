...
|---|---|---|---|---|---|---|---|
| Plasma decimator – standard | 48 | D6+3 | 3 | 8 | -3 | 2 | blast |
| Plasma decimator – supercharge | 48 | D6+3 | 3 | 9 | -4 | 3 | blast, hazardous |
...
- **Ion Aegis (Aura)** (Datasheet): While a friendly Armiger model is within 6" of this model, each time a ranged attack targets that model, it has the Benefit of Cover against that attack.
- **Titan Hunter** (Datasheet): Each time a ranged attack made by this model is allocated to a MONSTER or VEHICLE model, you can re-roll the Damage roll.

**Keywords:** Imperium, Knight Castellan, Walker, Titanic, Towering, Dominus, Character, Vehicle
