...
| Medusa siege cannon | 36 | D6 | 4 | 12 | -2 | 4 | blast, indirect fire |
...
- **Pinning Bombardment** (Datasheet): In your Shooting phase, after this model has shot, if one or more of those attacks made with its Medusa siege cannon scored a hit against an enemy INFANTRY unit, that unit must take a Battle-shock test.
- **One Shot** (Wargear profile): The bearer can only shoot with this weapon once per battle.

**Keywords:** Smoke, Imperium, Artillery, Vehicle, Squadron, Armageddon-pattern Medusa
...
- This model can be equipped with one of the following:- 1 storm bolter
- 1 heavy stubber
