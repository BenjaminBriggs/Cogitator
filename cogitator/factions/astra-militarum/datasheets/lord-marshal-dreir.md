...
*As is tradition in the armies of Krieg, Lord Marshal Varnan Dreir leads from the front, despite his lofty rank, often to the horror of his superiors. That he and his loyal Krieg steed have emerged from so many battles alive and victorious speaks to his skill as both commander and cavalry soldier.*
...
**Default Wargear:**
**This model is equipped with:** laspistol; Sabre of Sacrifice; savage claws.
...
|---|---|---|---|---|---|---|---|
| Sabre of Sacrifice | Melee | 6 | 2 | 6 | -2 | 1 | anti-infantry 4+ |
| Savage claws | Melee | 2 | 4 | 4 | -1 | 1 | extra attacks |
...
- **Tough to Kill** (Datasheet): The first time this model is destroyed, roll one D6 at the end of the phase. On a 2+, set this model back up on the battlefield as close as possible to where it was destroyed and not within Engagement Range of any enemy units, with D3 wounds remaining.
- **Leading the Charge** (Datasheet): Each time this model’s unit makes a Charge move, until the end of the turn, melee weapons equipped by models in that unit have the [DEVASTATING WOUNDS] ability.
- **ORDERS** (Special (правая колонка)): This OFFICER can issue up to 3 Orders to Regiment units.

**Keywords:** Character, Epic Hero, Grenades, Imperium, Mounted, Lord Marshal Dreir, Officer
