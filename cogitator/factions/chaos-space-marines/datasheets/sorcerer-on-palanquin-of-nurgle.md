...
- [LETHAL HITS]
- [SUSTAINED HITS 1]
- **Gift of Poxes (Psychic)** (Datasheet): While this model is leading a unit, weapons equipped by models in that unit have the [SUSTAINED HITS 1] ability.
- **Feculent Despair (Aura, Psychic)** (Datasheet): While an enemy unit is within 6" of this model, each time that unit takes a Battle-shock test, subtract 1 from that test.
