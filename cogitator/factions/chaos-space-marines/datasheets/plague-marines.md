...
| Plague spewer | 12 | D6 | N/A | 5 | -1 | 1 | anti-infantry 2+, ignores cover, torrent |
| Bolt pistol | 12 | 1 | 3 | 4 | 0 | 1 | lethal hits, pistol |
| Plague belcher | 12 | D6 | N/A | 4 | 0 | 1 | anti-infantry 4+, ignores cover, torrent |
...
|---|---|---|---|---|---|---|---|
| Bubotic weapons | Melee | 4 | 3 | 5 | -2 | 1 | lethal hits |
| Plague knives | Melee | 3 | 3 | 4 | 0 | 1 | lethal hits |
| Power fist | Melee | 3 | 3 | 8 | -2 | 2 | lethal hits |
| Heavy plague weapon | Melee | 3 | 4 | 8 | -2 | 2 | lethal hits |
...
- **Infused with the Blessings of Nurgle** (Datasheet): In your Shooting phase, each time this unit is selected to shoot, after this unit has shot, select one enemy unit hit by one or more of those attacks. Until the start of your next turn, that enemy unit is Afflicted.
- **Icon of Despair (Aura)** (Wargear): While an enemy unit is within 6" of the bearer, worsen the Leadership characteristic of models in that unit by 1.

**Keywords:** Chaos, Grenades, Infantry, Battleline, Plague Marines, Nurgle
**Faction Keywords:** Death Guard, Heretic Astartes
...
**Wargear Options:**
- The Plague Champion’s boltgun can be replaced with one of the following:- 1 bolt pistol
- 1 plasma gun
- 1 plasma pistol
- The Plague Champion’s plague knives can be replaced with one of the following:- 1 bubotic weapons
- 1 power fist
...
- For every 5 models in this unit, 1 Plague Marine’s boltgun can be replaced with one of the following:- 1 meltagun
- 1 plague belcher
- 1 plasma gun
...
**Leader:**
Led By: Chaos Lord On Palanquin Of Nurgle, Sorcerer On Palanquin Of Nurgle
