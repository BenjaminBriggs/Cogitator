...
|---|---|---|---|---|---|---|---|
| Magma cutters | 6 | 2 | 3 | 9 | -4 | D6 | melta 2 |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Lasher tendrils | Melee | 6 | 3 | 7 | -1 | 1 | extra attacks |
...
- [LETHAL HITS]
- [SUSTAINED HITS 1]
- **Siege Crawler** (Datasheet): You can ignore any or all modifiers to this model’s Move characteristic and to Advance and Charge rolls made for it.

**Keywords:** Maulerfiend, Chaos, Walker, Vehicle, Daemon
