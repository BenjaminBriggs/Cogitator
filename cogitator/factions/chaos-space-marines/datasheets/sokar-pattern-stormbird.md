...
| Hellstrike missile battery | 48 | 4 | 3 | 10 | -3 | D6 | anti-fly 3+ |
...
- [LETHAL HITS]
- [SUSTAINED HITS 1]
- **Aerial Assault** (Datasheet): Each time a unit with the Deep Strike ability disembarks from this model after it has made a Normal move, that unit is still eligible to declare a charge this turn.

**Keywords:** Vehicle, Sokar-pattern Stormbird, Chaos, Transport, Aircraft, Fly, Titanic, Vehicle, Sokar-pattern Stormbird, Chaos, Transport, Aircraft, Fly, Titanic, Vehicle, Aircraft, Aircraft, Fly, Sokar-pattern Stormbird, Chaos, Transport, Aircraft, Fly, Titanic, Vehicle, Sokar-pattern Stormbird, Chaos, Transport, Aircraft, Fly, Titanic, Vehicle, Sokar-pattern Stormbird, Chaos, Transport, Fly, Titanic, Vehicle, Sokar-pattern Stormbird, Chaos, Transport, Aircraft, Fly, Titanic, Vehicle, Sokar-pattern Stormbird, Chaos, Transport, Aircraft, Fly, Titanic, Vehicle, Sokar-pattern Stormbird, Chaos, Transport, Titanic
