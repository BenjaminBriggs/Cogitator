...
*Their bodies swollen with unholy power. Cultist Firebrands ore pyromaniacal champions of Chaos. Their very presence upon the battlefield infames the real of nearby cultists, driving them to ever-escalating acts of brutality and depravity.*
...
**Default Wargear:**
**This model is equipped with:** balefire pike, close combat weapon.

**Ranged Weapons**
| Name | Range | A | BS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Balefire pike | 12 | D6+3 | N/A | 5 | -1 | 1 | IGNORES COVER, TORRENT |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Close combat weapon | Melee | 4 | 4 | 4 | -1 | 1 | — |
...
- [LETHAL HITS]
- [SUSTAINED HITS 1]
- **Fiery Faith** (Datasheet): While this model is leading a unit, you can re-roll Leadership tests taken for that unit.
- **Cursed Flames** (Datasheet): In your Shooting phase, after this model has shot, select one enemy INFANTRY unit hit by one or more of those attacks. That unit must take a Battle-shock test.

**Keywords:** Cultist Firebrand, Damned, Chaos, Character, Grenades, Infantry
