...
- [LETHAL HITS]
- [SUSTAINED HITS 1]
- **Daemonkin (Psychic)** (Datasheet): While this model is leading a unit, add 1 to Advance and Charge rolls made for that unit.
- **Sacrificial Dagger** (Datasheet): Once per phase, when this model is selected to shoot or fight, it can use this ability. If it does, this model’s unit suffers 1 mortal wound and, until the end of the phase, each time this model makes a Psychic Attack, add 1 to the Hit roll and add 1 to the Wound roll.

**Keywords:** Character, Infantry, Master of Possession, Chaos, Psyker
...
**Leader:**
Can lead: Nemesis Claw, Legionaries, Possessed, Red Corsairs Raiders, Chosen
