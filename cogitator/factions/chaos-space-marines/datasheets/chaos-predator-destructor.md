...
- [LETHAL HITS]
- [SUSTAINED HITS 1]
- **Destructor** (Datasheet): Each time a ranged attack made by this model targets an enemy INFANTRY unit, improve the Armour Penetration characteristic of that attack by 1.

**Keywords:** Smoke, Vehicle, Chaos, Predator Destructor
