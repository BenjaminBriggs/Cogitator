...
|---|---|---|---|---|---|---|---|
| Eagle's Scream | 24 | 2 | 2 | 5 | -2 | 3 | assault |
...
- **Captain-General** (Datasheet): While this model is leading a unit, each time a model in this unit makes an attack, you can ignore any or all modifiers to that attack’s Ballistic skill or Weapon skill characteristics and/or all modifiers to the Hit roll
- **Moment Shackle** (Datasheet): Once per battle, at the start of the Fight phase, you can select one of the following to take effect until the end of the phase:
...
**Keywords:** Infantry, Character, Imperium, Epic Hero, Trajann Valoris
