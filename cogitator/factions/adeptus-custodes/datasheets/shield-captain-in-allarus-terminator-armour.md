...
- **Auramite and Adamantine** (Datasheet): Once per battle, at the start of any phase, this model can use this ability If it does, until the end of the phase, each time an attack is allocated to this model, change the Damage characteristic of that attack to 1.
...
**Keywords:** Infantry, Imperium, Shield-Captain, Terminator, Character
