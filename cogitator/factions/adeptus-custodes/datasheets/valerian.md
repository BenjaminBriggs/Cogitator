...
*A headstrong warrior, Valerian is relatively new to the Custodes, but is already marked for greatness. His urge to bring death to the foes of the Emperor beyond Terra is much valued in these dark times, and countless enemies have fallen to his guardian spear, Gnosis.*
...
|---|---|---|---|---|---|---|---|
| Gnosis | 24 | 3 | 2 | 4 | -1 | 2 | assault |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Gnosis | Melee | 7 | 2 | 8 | -3 | 2 | — |
...
- **Golden Laurels** (Datasheet): While this model is leading a unit, each time a melee attack targets that unit, worsen the Armour Penetration characteristic of that attack by 1.
- **Hero of Lion’s Gate** (Datasheet): Once per battle, after making a Hit roll, Wound roll or saving throw for this model, you can change the result of that roll to an unmodified 6.

**Keywords:** Valerian, Epic Hero, Infantry, Character, Imperium, Shield-Captain
