...
|---|---|---|---|---|---|---|---|
| Twin arachnus blaze cannon | 24 | 8 | 2 | 5 | -1 | 1 | devastating wounds, twin-linked |
...
- **Merciless Hunter** (Datasheet): In your Shooting phase, each time this model makes an attack that targets an enemy unit that is Below Half-strength, add 1 to the Wound roll.

**Keywords:** Imperium, Pallas Grav-attack, Vehicle, Fly
