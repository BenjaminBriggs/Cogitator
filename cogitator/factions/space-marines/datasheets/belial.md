...
**Default Wargear:**
**This model is equipped with:** master-crafted storm bolter; the Sword of Silence.

**Ranged Weapons**
| Name | Range | A | BS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Master-crafted storm bolter | 24 | 2 | 2 | 4 | 0 | 2 | precision, rapid fire 2 |
...
- **Grand Master of the Deathwing** (Datasheet): While this model is leading a unit, each time a model in that unit makes an attack, if a Critical Hit is scored, that attack has the [PRECISION] ability.
- **Strikes of Retribution** (Datasheet): Each time a melee attack is allocated to this model, after the attacking model’s unit has finished making its attacks, roll one D6 (to a maximum of six D6 per attacking unit): for each 4+, the attacking unit suffers 1 mortal wound.

**Keywords:** Terminator, Imperium, Epic Hero, Character, Deathwing, Belial, Infantry, Captain
...
**Leader:**
Can lead: Terminator Squad, Deathwatch Terminator Squad, Terminator Squad, Relic Terminator Squad, Deathwing Knights, Deathwing Command Squad, Deathwing Terminator Squad, Terminator Assault Squad
