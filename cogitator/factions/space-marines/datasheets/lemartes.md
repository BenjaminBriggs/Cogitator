...
**Default Wargear:**
**This model is equipped with:** absolvor bolt pistol; the Blood Crozius.

**Ranged Weapons**
| Name | Range | A | BS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Absolvor bolt pistol | 18 | 1 | 2 | 5 | -1 | 2 | pistol |
...
- **Guardian of the Lost** (Datasheet): While this model is leading a unit, each time an attack is allocated to a model in that unit, subtract 1 from the Damage characteristic of that attack.
- **Fury Unbound** (Datasheet): While this model is leading a unit, melee weapons equipped by models in that unit have the [LETHAL HITS] ability

**Keywords:** Infantry, Character, Jump Pack, Grenades, Imperium, Tacticus, Chaplain, Lemartes, Fly, Epic Hero
...
**Leader:**
Can lead: Death Company Marines with Boltguns and Jump Packs, Death Company Marines With Jump Packs
