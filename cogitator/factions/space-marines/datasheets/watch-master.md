...
|---|---|---|---|---|---|---|---|
| Vigil spear | Melee | 6 | 2 | 6 | -2 | D3 | lance |
...
- **Mission Tactics** (Faction): At the start of your Command phase, you can select one of the Mission Tactics listed below. Until the start of your next Command phase, that Mission Tactic is active and its effects apply to all units from your army with this ability. Each Mission Tactic can only be selected once per battle.FUROR TACTICS
...
- **Strategic Knowledge** (Datasheet): While this model is leading a unit, that unit is eligible to shoot and declare a charge in a turn in which it Advanced or Fell Back.
- **Watch Master** (Datasheet): Once per battle round, one unit from your army with this ability can use it when its unit is targeted with a Stratagem. If it does, reduce the CP cost of that use of that Stratagem by 1CP.

**Keywords:** Imperium, Watch Master, Grenades, Captain, Character, Infantry
**Faction Keywords:** Deathwatch, Adeptus Astartes
...
**Leader:**
Can lead: Deathwatch Veterans, Fortis Kill Team
