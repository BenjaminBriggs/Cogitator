...
**Default Wargear:**
**This model is equipped with:** 1 artisan plasma pistol; 1 Talassarian tempest blade.
...
|---|---|---|---|---|---|---|---|
| Talassarian tempest blade – strike | Melee | 4 | 2 | 6 | -3 | 3 | devastating wounds |
| Talassarian tempest blade – sweep | Melee | 9 | 2 | 5 | -2 | 1 | sustained hits 1 |
| Talassarian tempest blade – coup de grace | Melee | 6 | 2 | 5 | -2 | 2 | precision |
...
- **Knight Champion of Macragge** (Datasheet): Once per turn, when an enemy unit ends a Normal, Advance or Fall Back move within 9" of this model’s unit, if this unit is not within Engagement Range of one or more enemy units, it can make a Normal move of up to 6".
- **Honour or Death** (Datasheet): You can target this unit with the Heroic Intervention Stratagem for 0CP, even if you have already used that Stratagem on a different unit this phase.
- **CAPTAIN OF THE HONOUR GUARD** (Fortification (левая колонка)): Your army cannot include more than one Captain Sicarius unit.

**Keywords:** Infantry, Character, Epic Hero, Imperium, Tacticus, Captain, Cato, Sicarius
