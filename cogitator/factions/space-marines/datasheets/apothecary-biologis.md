...
*Clad in Gravis armour, the Apothecary Biologis can advance through storms of enemy fire, vivispectrum at the ready to take bio-material samples for later analysis, whether that be xenos flesh, viral weapons casings or esoteric gene-tech.*
...
**Default Wargear:**
**This model is equipped with:** absolvor bolt pistol; close combat weapon.
...
- **Surgical Precision** (Datasheet): While this model is leading a unit, weapons equipped by models in that unit have the [LETHAL HITS] ability.
- **Vivispectrum** (Datasheet): If this model’s unit destroys an enemy unit as the result of a melee attack, until the end of the battle, this model has an Objective Control characteristic of 9.

**Keywords:** Biologis, Character, Gravis, Imperium, Apothecary, Infantry
...
**Leader:**
Can lead: Aggressor Squad, Eradicator Squad, Heavy Intercessor Squad, Indomitor Kill Team
