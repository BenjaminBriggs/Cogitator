...
**Default Wargear:**
**This model is equipped with:** bolt pistol; crushing teeth and claws; Glacius.
...
|---|---|---|---|---|---|---|---|
| Crushing teeth and claws | Melee | 3 | 3 | 5 | -1 | 1 | extra attacks |
...
- **Lord of the Wolfkin** (Datasheet): While this model is leading a unit, each time that unit makes a Charge move, until the end of the turn, crushing teeth and claws equipped by models in that unit have the [DEVASTATING WOUNDS] ability.
- **Mantle of the Troll King** (Datasheet): Once per phase, when resolving an attack made against this model, after you make a saving throw for this model, you can change the Damage characteristic of that attack to 0.

**Keywords:** Harald Deathwolf, Captain, Imperium, Grenades, Epic Hero, Character, Mounted
