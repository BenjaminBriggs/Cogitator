...
- **Aquilon Optics** (Datasheet): Each time this model is selected to shoot, you can re-roll one Hit roll, you can re-roll one Wound roll and you can re-roll one Damage roll when resolving its attacks.
...
- This model can be equipped with one of the following:- 1 ironhail heavy stubber
- 1 multi-melta
