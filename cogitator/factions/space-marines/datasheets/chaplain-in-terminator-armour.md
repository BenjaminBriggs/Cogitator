...
- **Recitation of Faith** (Datasheet): While this model is leading a unit, models in that unit have the Feel No Pain 4+ ability against mortal wounds.
- **Relic Shield** (Wargear): The bearer has a Wounds characteristic of 6.

**Keywords:** Imperium, Terminator, Chaplain, Deathwing, Infantry, Character
