...
*Tasked with upholding the martial honour of their battle-brothers, Primaris Company Champions are bladesmen supreme. They are veteran combatants and peerless duellists, cleaving apart lesser foes to reach the enemy’s greatest champions face to face, there to humble them.*
...
|---|---|---|---|---|---|---|---|
| Master-crafted power weapon | Melee | 5 | 2 | 5 | -2 | 2 | precision |
...
- **Honour or Death** (Datasheet): While this model is leading a unit, add 1 to Advance and Charge rolls made for that unit and you can target that unit with the Heroic Intervention Stratagem for 0CP, even if you have already used that Stratagem on a different unit this phase.
- **Martial Superiority** (Datasheet): Each time this model makes a melee attack that targets a CHARACTER unit, you can re-roll the Hit roll and you can re-roll the Wound roll.

**Keywords:** Character, Infantry, Imperium, Primaris Company Champion, Tacticus, Grenades
...
**Leader:**
Can lead: Sternguard Veteran Squad, Crusader Squad, Bladeguard Veteran Squad, Sternguard Veteran Squad, Sword Brethren Squad, Infernus Squad, Fortis Kill Team, Intercessor Squad, Assault Intercessor Squad, Vanguard Veteran Squad, Wolf Guard, Inner Circle Companions, Assault Squad, Deathwatch Veterans, Decimus Kill Team
