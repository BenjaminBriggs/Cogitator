...
|---|---|---|---|---|---|---|---|
| Disintegration combi-gun | 24 | 1 | 4 | 5 | -1 | 1 | anti-infantry 4+, devastating wounds, rapid fire 1 |
| Disintegration pistol | 12 | 1 | 3 | 5 | -1 | 1 | anti-infantry 4+, devastating wounds, pistol |
...
- **Swift Assault** (Datasheet): While this model is leading a unit, ranged weapons equipped by models in that unit have the [ASSAULT] ability.
- **Unbreakable Duty** (Datasheet): While this model is within range of an objective marker and/or within 6" of the centre of the battlefield, this model has the Feel No Pain 4+ ability.

**Keywords:** Character, Imperial Space Marine, Grenades, Imperium, Infantry
...
**Leader:**
Can lead: Tactical Squad, Long Fangs, Assault Squad, Vanguard Veteran Squad With Jump Packs, Crusader Squad (Legendary), Devastator Squad, Command Squad, Wolf Guard, Vanguard Veteran Squad
