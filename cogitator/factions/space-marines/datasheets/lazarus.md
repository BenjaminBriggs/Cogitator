...
*Master Lazarus wields his sword, Enmity’s Edge, with all the martial skill expected of a Dark Angels Company Master. In even the most ferocious fighting he exhibits a calm demeanour, maintaining composure while giving masterful orders that have yielded great victories.*
...
**Default Wargear:**
**This model is equipped with:** bolt pistol; Enmity’s Edge.
...
|---|---|---|---|---|---|---|---|
| Enmity’s Edge | Melee | 6 | 2 | 6 | -3 | 2 | anti-psyker 2+ |
...
- **Intractable Will** (Datasheet): While this model is leading a unit, each time a model in that unit is destroyed by a melee attack, if that model has not fought this phase, roll one D6. On a 4+, do not remove it from play; that destroyed model can fight after the attacking model’s unit has finished making its attacks, and is then removed from play.
- **The Spiritshield Helm** (Datasheet): This model has the Feel No Pain 3+ ability against Psychic Attacks and mortal wounds.

**Keywords:** Imperium, Grenades, Epic Hero, Character, Infantry, Deathwing, Tacticus, Lazarus, Captain
...
**Leader:**
Can lead: Sternguard Veteran Squad, Tactical Squad, Infernus Squad, Deathwatch Veterans, Crusader Squad (Legendary), Inner Circle Companions, Vanguard Veteran Squad, Wolf Guard, Assault Squad, Sword Brethren Squad, Sternguard Veteran Squad, Bladeguard Veteran Squad, Assault Intercessor Squad, Intercessor Squad, Crusader Squad, Fortis Kill Team, Decimus Kill Team
