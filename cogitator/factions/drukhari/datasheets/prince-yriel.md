...
**Default Wargear:**
**This model is equipped with:** Eye of Wrath; shuriken pistol; Spear of Twilight.
...
|---|---|---|---|---|---|---|---|
| Spear of Twilight | Melee | 5 | 2 | 7 | -3 | 3 | lance |
...
- **Piratical Hero** (Datasheet): While this model is leading a unit, each time a model in that unit makes an attack, that attack has the [SUSTAINED HITS 1] ability and add 1 to the Hit roll.
- **Prince of Corsairs** (Datasheet): After both players have deployed their armies, if this unit is on the battlefield (or any Transport it is embarked within is on the battlefield), select up to three AELDARI units from your army and redeploy them. When doing so, you can set those units up in Strategic Reserves, regardless of how many units are already in Strategic Reserves.

**Keywords:** Infantry, Aeldari, Character, Epic Hero, Anhrathe, Prince Yriel
