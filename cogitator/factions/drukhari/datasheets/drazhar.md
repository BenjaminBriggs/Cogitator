...
|---|---|---|---|---|---|---|---|
| Executioner’s demiklaives – single blade | Melee | 6 | 2 | 6 | -2 | 3 | devastating wounds |
| Executioner’s demiklaives – dual blades | Melee | 8 | 2 | 5 | -2 | 2 | devastating wounds |
...
- **Power from Pain** (Faction): Pain Abilities
...
- **Master of Blades (Pain)** (Datasheet): In the Fight phase, when you select this model’s unit to fight, you can spend 1 Pain token to Empower that unit. While that unit is Empowered, each time a model in that unit makes a melee attack, add 1 to the Wound roll.
- **Onslaught** (Datasheet): While this model is leading a unit, each time a model in that unit makes a Pile-in or Consolidation move, it can move up to 6" instead of up to 3".
- **Silent Executioner** (Datasheet): Each time this model makes an attack that targets a unit that is below its Starting Strength, you can re-roll the Hit roll. If that target is Below Half-strength, you can re-roll the Wound roll as well.

**Keywords:** Character, Infantry, Blades for Hire, Aeldari, Epic Hero, Drazhar
