...
| Splinterstorm cannon | 36 | 8 | 3 | 3 | -1 | 2 | anti-infantry 3+, sustained hits 2 |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Bladed wings | Melee | 3 | 4 | 6 | -1 | 1 | — |
...
- **Shredding Fire (Pain)** (Datasheet): In your Shooting phase, when you select this unit to shoot, you can spend 1 Pain token to Empower this unit. While Empowered, the Armour Penetration characteristic of its ranged weapons is increased by 1.
- **Ground-attack Craft** (Datasheet): Each time a model in this unit makes a ranged attack that targets an enemy unit (excluding units that can FLY), add 1 to the Hit roll.

**Keywords:** Raven Strike Fighter, Aeldari, Aircraft, Fly, Vehicle
