...
|---|---|---|---|---|---|---|---|
| Fusion pistol | 6 | 1 | 3 | 8 | -4 | D6 | assault, melta 2, pistol |
| Executioner | 18 | 3 | 3 | 6 | -2 | D3 | anti-infantry 2+, psychic |
| Wraithcannon | 18 | 1 | 3 | 14 | -4 | D6+1 | — |
| Blaster | 18 | 1 | 3 | 8 | -4 | D6+1 | assault |
| Long rifle | 36 | 1 | 3 | 4 | -1 | 2 | heavy, precision |
| Neuro disruptor | 12 | 1 | 3 | 4 | -2 | 1 | anti-infantry 2+, assault, pistol |
...
| Shuriken rifle | 24 | 1 | 3 | 4 | -1 | 1 | assault, rapid fire 1 |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Close combat weapon | Melee | 3 | 3 | 3 | 0 | 1 | — |
| Paired Hekatarii blades | Melee | 4 | 2 | 3 | -2 | 1 | twin-linked |
...
- **Piratical Raiders** (Datasheet): At the start of the battle, select one unit from your opponent’s army. Weapons equipped by models in this unit have the [LETHAL HITS] and [PRECISION] abilities while targeting that unit.
- **Channeller Stones** (Wargear): Once per turn, the first time a saving throw is failed for the bearer’s unit, change the Damage characteristic of that attack to 0.
- **Faolchú** (Wargear): Ranged weapons equipped by models in the bearer’s unit have the [IGNORES COVER] ability.
- **Mistshield** (Wargear): The bearer has a 4+ invulnerable save.

**Keywords:** Aeldari, Grenades, Anhrathe, Corsair Voidscarred, Psyker, Infantry
**Faction Keywords:** Asuryani, Drukhari
...
- The Voidscarred Felarch’s shuriken pistol can be replaced with one of the following:- 1 neuro disruptor
- 1 shuriken rifle
...
- 1 blaster
- 1 shredder
- If this unit contains 10 models, 1 Corsair Voidscarred’s shuriken rifle can be replaced with one of the following:- 1 shuriken cannon
- 1 wraithcannon
