...
- [LETHAL HITS]
- [SUSTAINED HITS 1]
- **Faithful Flock** (Datasheet): While this unit is leading a unit and contains a CULT DEMAGOGUE model, models in that unit have a 5+ invulnerable save.
- **Dark Ritual** (Datasheet): Once per battle, in your Command phase, if this unit contains a CULT DEMAGOGUE model, it can use this ability. If it does, until the end of the turn, this unit can declare a charge in a turn in which it Advanced and each time a model in this unit makes an attack, add 1 to the Hit roll and add 1 to the Wound roll.
- **Chaos Icon** (Wargear): Each time the bearer’s unit takes a Leadership test for the Dark Pacts ability, you can re-roll that test.

**Keywords:** Chaos, Damned, Dark Commune, Psyker, Character, Cult Demagogue, Undivided, Shadow Legion, Infantry, Grenades, Dark Commune, Chaos, Damned, Dark Commune, Psyker, Character, Cult Demagogue, Undivided, Shadow Legion, Infantry, Grenades, Chaos, Damned, Dark Commune, Psyker, Character, Cult Demagogue, Undivided, Shadow Legion, Infantry, Grenades, Chaos, Damned, Psyker, Character, Cult Demagogue, Undivided, Shadow Legion, Infantry, Grenades, Chaos, Damned, Dark Commune, Psyker, Character, Cult Demagogue, Undivided, Shadow Legion, Infantry, Grenades, Chaos, Damned, Dark Commune, Psyker, Character, Cult Demagogue, Undivided, Shadow Legion, Infantry, Grenades, Chaos, Damned, Dark Commune, Psyker, Character, Cult Demagogue, Undivided, Shadow Legion, Infantry, Grenades, Chaos, Damned, Dark Commune, Psyker, Character, Cult Demagogue, Undivided, Shadow Legion, Infantry, Grenades
...
**Leader:**
Can lead: Cultist Mob, Accursed Cultists
