...
|---|---|---|---|---|---|---|---|
| Balesword and Nurgling attendants | Melee | D6+3 | 3 | 5 | -2 | 2 | lethal hits |
...
- **Blessed by the Plague God** (Datasheet): While this model is leading a unit, models in that unit have a 4+ invulnerable save.
- **Tally of Pestilence** (Datasheet): Keep a tally of how many enemy models are destroyed by Nurgle Legiones Daemonica models from your army during the battle. At the start of your Command phase, if this tally is 7 or more, you gain 1CP and the tally is reset to 0.

**Keywords:** Epidemius, Nurgle, Daemon, Chaos, Infantry, Character, Epic Hero
