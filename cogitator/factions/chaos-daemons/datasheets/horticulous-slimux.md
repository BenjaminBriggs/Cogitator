...
|---|---|---|---|---|---|---|---|
| Acidic maw | Melee | 2 | 4 | 7 | -4 | 3 | devastating wounds, extra attacks |
| Lopping shears | Melee | 4 | 3 | 6 | -2 | 3 | lethal hits |
...
- **Beast Handler** (Datasheet): While this model is leading a unit, you can re-roll Charge rolls made for that unit. In addition, once per battle, you can target that unit with the Heroic Intervention Stratagem for 0CP, and can do so even if you have already used that Stratagem on a different unit this phase.
- **Seed the Garden of Nurgle** (Datasheet): At the end of your Movement phase, if this model is within one Area Terrain feature, until the end of the battle, that AREA TERRAIN feature is considered to be within your army’s Shadow of Chaos.

**Keywords:** Mounted, Horticulous Slimux, Character, Epic Hero, Nurgle, Daemon, Chaos
