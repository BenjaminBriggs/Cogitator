...
|---|---|---|---|---|---|---|---|
| Corrupted stave | Melee | 2 | 4 | 4 | -1 | D3 | devastating wounds, psychic |
...
- [LETHAL HITS]
- [SUSTAINED HITS 1]
- **Bestial Raiders** (Datasheet): If this unit starts the game in Strategic Reserves, it can be set up in the Reinforcements step of your first, second or third Movement phase, regardless of any mission rules. If this unit is in Strategic Reserves, for the purposes of setting up this unit on the battlefield, treat the current battle round number as being one higher than it actually is.

**Keywords:** Grenades, Damned, Fellgor Beastmen, Undivided, Shadow Legion, Infantry, Grenades, Chaos, Damned, Undivided, Shadow Legion, Infantry, Grenades, Chaos, Damned, Fellgor Beastmen, Undivided, Chaos, Shadow Legion, Infantry, Grenades, Damned, Fellgor Beastmen, Undivided, Shadow Legion, Infantry, Grenades, Chaos, Chaos, Damned, Fellgor Beastmen, Undivided, Shadow Legion, Infantry, Fellgor Beastmen
