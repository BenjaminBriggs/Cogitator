...
|---|---|---|---|---|---|---|---|
| Bloodlash | 12 | 9 | 2 | 8 | 0 | 2 | — |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Axe of Khorne – strike | Melee | 8 | 2 | 16 | -4 | D6+2 | — |
| Axe of Khorne – sweep | Melee | 16 | 2 | 10 | -2 | 2 | — |
...
- **Emissary of the Blood God (Aura)** (Datasheet): While a friendly Khorne Legiones Daemonica unit is within 6" of this model, you can re-roll Battle-shock tests taken for that unit.
- **Relentless Carnage** (Datasheet): At the end of the Fight phase, you can select one enemy unit within Engagement Range of this model and roll eight D6: for each 4+, that enemy unit suffers 1 mortal wound.

**Keywords:** Monster, Character, Epic Hero, Titanic, Towering, Chaos, Daemon, An'ggrath the Unbound, Khorne
