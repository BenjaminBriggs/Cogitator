...
- [LETHAL HITS]
- [SUSTAINED HITS 1]
- **Despoilers** (Datasheet): Each time this unit makes a Dark Pact, until the end of the phase, each time a model in this unit makes an attack, you can re-roll the Hit roll.

**Keywords:** Shadow Legion, Undivided, Chaos Terminator Squad, Terminator, Chaos, Infantry, Shadow Legion, Undivided, Chaos Terminator Squad, Terminator, Chaos, Infantry, Shadow Legion, Chaos Terminator Squad, Terminator, Chaos, Infantry, Shadow Legion, Undivided, Chaos Terminator Squad, Terminator, Chaos, Infantry, Undivided
...
**Wargear Options:**
- For every 5 models in this unit, 1 Terminator’s combi-bolter can be replaced with one of the following:- 1 heavy flamer
- 1 reaper autocannon
...
**Leader:**
Led By: Chaos Lord In Terminator Armour, Sorcerer In Terminator Armour
