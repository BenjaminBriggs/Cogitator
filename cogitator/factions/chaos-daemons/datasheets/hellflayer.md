...
*Mortal myth has it that the Hellflayers of Slaanesh began as devices for mowing the gruesome pleasure-gardens of the Dark Prince’s realm, but that their efficacy in war was soon proven when their wild Daemonette crews unleashed the whirl-bladed murder engines upon the battlefields of realspace.*
...
|---|---|---|---|---|---|---|---|
| Lashes of torment | 6 | 6 | 3 | 4 | 0 | 1 | anti-infantry 3+, assault, pistol |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Bladed axle | Melee | 6 | 3 | 6 | -1 | 2 | extra attacks |
| Seeker tongues | Melee | 4 | 4 | 4 | 0 | 1 | extra attacks, lethal hits |
| Slashing claws | Melee | 9 | 3 | 4 | 0 | 1 | devastating wounds |
...
- **Cutting Down the Foe** (Datasheet): Each time this unit is selected to fight, you can select one enemy unit within Engagement Range of it and roll one D6, adding 2 to the result if that unit is an INFANTRY unit: on a 2-3, that enemy unit suffers D3 mortal wounds; on a 4-5, that enemy unit suffers 3 mortal wounds; on a 6+, that enemy unit suffers D3+3 mortal wounds.

**Keywords:** Hellflayer, Daemon, Chaos, Mounted, Shadow Legion, Slaanesh
