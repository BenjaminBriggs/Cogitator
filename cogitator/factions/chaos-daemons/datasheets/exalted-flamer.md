...
|---|---|---|---|---|---|---|---|
| Fire of Tzeentch – blue fire | 18 | 3 | 3 | 9 | -3 | 3 | ignores cover, psychic |
| Fire of Tzeentch – pink fire | 12 | 2D6 | N/A | 5 | -1 | 1 | ignores cover, psychic, torrent |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Flamer mouths | Melee | 4 | 4 | 5 | 0 | 1 | — |
...
- **Blazing Warpfire (Psychic)** (Datasheet): While this model is leading a unit, ranged weapons equipped by models in that unit have the [ASSAULT] ability.
- **Flames of Change (Psychic)** (Datasheet): In your Shooting phase, after this model has shot, select one enemy unit (excluding MONSTERS and VEHICLES) hit by one or more of those attacks, and roll one D6. On a 4+, until the end of your opponent’s next turn, that enemy unit is aflame. While a unit is aflame, subtract 2" from its Move characteristic and subtract 2 from Advance and Charge rolls made for it.
- **MANIFESTATION OF DESTRUCTION** (Special (правая колонка)): This model cannot be your Warlord and cannot be given Enhancements.

**Keywords:** Character, Shadow Legion, Daemon, Fly, Tzeentch, Exalted Flamer, Infantry, Chaos
