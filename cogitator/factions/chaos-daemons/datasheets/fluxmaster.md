...
- **Fluxmaster** (Datasheet): While this model is leading a unit, each time an attack is made against that unit, subtract 1 form the Hit roll.
...
**Keywords:** Tzeentch, Daemon, Chaos, Psyker, Fly, Mounted, Character, Shadow Legion, Fluxmaster
