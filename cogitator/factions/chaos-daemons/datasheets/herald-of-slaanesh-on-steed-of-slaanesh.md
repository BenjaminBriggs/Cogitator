...
| Ravaging claws | Melee | 6 | 2 | 4 | -1 | 1 | devastating wounds |
...
- **Lethal Caress** (Datasheet): While this model is leading a unit, improve the Armour Penetration characteristic of melee weapons equipped by models in that unit by 1.
- **Symphony of Pain (Psychic)** (Datasheet): At the end of your Movement phase, you can select one enemy unit that is Battle-shocked and within 12" of this model. Until the end of the turn, each time a Slaanesh Legiones Daemonica model from your army makes an attack that targets that enemy unit, you can re-roll the Hit roll and you can re-roll the Wound roll.

**Keywords:** Herald of Slaanesh, Chaos, Mounted, Psyker, Character, Daemon, Slaanesh, Shadow Legion
