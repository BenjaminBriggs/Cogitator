...
- [LETHAL HITS]
- [SUSTAINED HITS 1]
- **Prescience (Psychic)** (Datasheet): While this model is leading a unit, each time an attack targets that unit, subtract 1 from the Hit roll.
- **Gift of Chaos (Psychic)** (Datasheet): Each time this model is selected to shoot or fight, after resolving its attacks, select one enemy unit hit by one or more of those attacks that had the [PSYCHIC] ability. That unit must take a Leadership test: if that test is failed, that unit suffers D3 mortal wounds.

**Keywords:** Grenades, Chaos, Sorcerer, Undivided, Shadow Legion, Infantry, Character, Psyker, Grenades, Chaos, Sorcerer, Undivided, Chaos, Sorcerer, Shadow Legion, Undivided, Infantry, Character, Psyker, Shadow Legion, Infantry, Character, Psyker, Grenades, Chaos, Sorcerer, Undivided, Shadow Legion, Infantry, Character, Psyker, Grenades, Chaos, Sorcerer, Undivided, Shadow Legion, Infantry, Character, Psyker, Grenades, Chaos, Sorcerer, Undivided, Shadow Legion, Infantry, Character, Psyker, Grenades
