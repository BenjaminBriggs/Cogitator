...
- **Bloodmaster** (Datasheet): While this model is leading a unit, each time a model in that unit makes an attack, add 1 to the Wound roll.
- **A Gory Path** (Datasheet): Each time this model’s unit Consolidates, it can move up to 6" instead of up to 3".

**Keywords:** Character, Infantry, Chaos, Daemon, Khorne, Bloodmaster, Shadow Legion
