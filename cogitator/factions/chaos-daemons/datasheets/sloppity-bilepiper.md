...
|---|---|---|---|---|---|---|---|
| Marotter | Melee | 4 | 3 | 5 | 0 | 1 | lethal hits |
...
- **Jolly Gutpipes** (Datasheet): While this model is leading a unit, add 1 to the Move characteristic of models in that unit and you can re-roll Advance rolls made for that unit.
- **Disease of Mirth (Aura)** (Datasheet): At the start of the Fight phase, every enemy unit (excluding MONSTERS and VEHICLES) within 6" of this model must take a Battle-shock test.

**Keywords:** Daemon, Chaos, Character, Infantry, Shadow Legion, Sloppity Bilepiper, Nurgle
