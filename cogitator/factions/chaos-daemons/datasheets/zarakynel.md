...
- **Emissary of the Prince of Excess (Aura)** (Datasheet): While a friendly Slaanesh Legiones Daemonica unit is within 6" of this model, you can re-roll Battle-shock tests taken for that unit.
- **Mesmerising Form** (Datasheet): Each time an attack targets this model, subtract 1 from the Hit roll.

**Keywords:** Character, Monster, Psyker, Chaos, Daemon, Epic Hero, Zarakynel, Slaanesh
