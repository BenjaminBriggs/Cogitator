...
*Whirling amidst capering masses of daemonic Horrors, these Heralds are potent sorcerers whose presence causes the fires of their fellow daemons to spread with infernal vigour. Changecasters unleash storms of mutating sorcery against their enemies, jabbering and cackling as they wreak gruesome havoc.*
...
- **Changecaster** (Datasheet): While this model is leading a unit, ranged weapons equipped by models in that unit have the [SUSTAINED HITS 1] ability.
- **Storm of Mutating Sorcery (Psychic)** (Datasheet): In your Shooting phase, after this model has shot, select one enemy Infantry unit hit by one or more of those attacks. That unit must take a Battle-shock test.

**Keywords:** Infantry, Character, Shadow Legion, Psyker, Daemon, Tzeentch, Chaos, Changecaster
...
**Leader:**
Can lead: Pink Horrors, Blue Horrors
