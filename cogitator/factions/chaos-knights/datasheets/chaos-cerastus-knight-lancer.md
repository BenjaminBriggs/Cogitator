...
|---|---|---|---|---|---|---|---|
| Cerastus shock lance | 12 | 6 | 3 | 6 | 0 | 2 | assault, sustained hits 2 |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Cerastus shock lance – strike | Melee | 5 | 2 | 20 | -3 | 8 | lance |
...
- **Shock Charge** (Datasheet): You can target this model with the Tank Shock Stratagem for 0CP, and can do so even if you have already targeted a different unit with that Stratagem this phase.
- **Dark Fervour (Aura)** (Datasheet): While a friendly War Dog model is within 6" of this model, ranged weapons equipped by that War Dog model have the [ASSAULT] ability.

**Keywords:** Towering, Chaos, Cerastus, Knight Lancer, Vehicle, Walker, Character, Titanic
