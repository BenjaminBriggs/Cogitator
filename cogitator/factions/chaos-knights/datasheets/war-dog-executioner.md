...
|---|---|---|---|---|---|---|---|
| Daemonbreath meltagun | 12 | 1 | 3 | 9 | -4 | D6 | melta 2 |
| Diabolus heavy stubber | 36 | 3 | 3 | 5 | 0 | 1 | rapid fire 3 |
| War Dog autocannon | 48 | 4 | 3 | 9 | -1 | 3 | — |
...
- **Executioner** (Datasheet): Each time this model makes an attack that targets a unit Below Half-strength, add 1 to the Hit roll. Each time an enemy unit is destroyed as the result of this model’s attacks, before removing the last model in that unit from the battlefield, each unit from your opponent’s army that is within 3" of it must take a Battle-shock test.
