...
|---|---|---|---|---|---|---|---|
| Reaper chainsword – strike | Melee | 6 | 2 | 14 | -4 | 6 | sustained hits 1 |
| Reaper chainsword – sweep | Melee | 18 | 2 | 9 | -3 | 2 | sustained hits 1 |
| Warpstrike claw – strike | Melee | 6 | 2 | 20 | -3 | 8 | sustained hits 1 |
| Warpstrike claw – sweep | Melee | 12 | 2 | 10 | -2 | 3 | sustained hits 1 |
...
- **Bloodlust** (Datasheet): Each time this model makes a Charge move, until the end of the turn, its melee weapons have the [DEVASTATING WOUNDS] ability.
- **Frenzied Rampage (Aura)** (Datasheet): While a friendly War Dog model is within 9" of this model, each time that WAR DOG model makes a melee attack, re-roll a Hit roll of 1.

**Keywords:** Towering, Abhorrent, Knight Rampager, Chaos, Titanic, Vehicle, Walker, Character
