...
| Autogun | 24 | 1 | 4 | 3 | 0 | 1 | rapid fire 1 |
...
- [LETHAL HITS]
- [SUSTAINED HITS 1]
- **For the Dark Gods** (Datasheet): At the end of your Command phase, if this unit is within range of an objective marker you control, that objective marker remains under your control until your opponent’s Level of Control over that objective marker is greater than yours at the end of a phase.

**Keywords:** Battleline, Grenades, Chaos, Damned, Cultist Mob with Firearms, Infantry
