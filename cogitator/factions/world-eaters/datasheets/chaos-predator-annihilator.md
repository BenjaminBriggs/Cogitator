...
|---|---|---|---|---|---|---|---|
| Combi-bolter | 24 | 2 | 4 | 4 | 0 | 1 | rapid fire 4 |
| Combi-weapon | 24 | 1 | 4 | 4 | 0 | 1 | anti-infantry 4+, devastating wounds, rapid fire 1 |
| Havoc launcher | 48 | D6 | 4 | 5 | 0 | 1 | blast |
| Heavy bolter | 36 | 3 | 4 | 5 | -1 | 2 | rapid fire 2, sustained hits 1 |
| Lascannon | 48 | 1 | 4 | 12 | -3 | D6+1 | — |
| Predator twin lascannon | 48 | 1 | 4 | 14 | -3 | D6+1 | rapid fire 2, twin-linked |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Armoured tracks | Melee | 6 | 3 | 6 | 0 | 1 | — |
...
- **Blood-hungry Annihilator** (Datasheet): Each time this model makes a ranged attack that targets the closest eligible MONSTER or VEHICLE target within 18", you can re-roll the Wound roll and you can re-roll the Damage roll.

**Keywords:** Vehicle, Chaos, Smoke, Khorne, Predator Annihilator
