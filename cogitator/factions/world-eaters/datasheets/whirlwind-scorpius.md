...
- **Pinning Bombardment** (Datasheet): In your Shooting phase, after this model has shot, if one or more of those attacks made with its Scorpius multi-launcher scored a hit against an enemy INFANTRY unit, that unit must take a Battle-shock test.
- **One Shot** (Wargear profile): The bearer can only shoot with this weapon once per battle.

**Keywords:** Whirlwind Scorpius, Vehicle, Smoke, Chaos, Khorne, Whirlwind Scorpius, Vehicle, Smoke, Chaos, Khorne, Whirlwind Scorpius, Vehicle, Smoke, Chaos, Khorne, Whirlwind Scorpius, Vehicle, Smoke, Chaos, Khorne
