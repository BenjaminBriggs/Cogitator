...
- **Interceptor** (Datasheet): Each time this model makes a ranged attack that targets a unit that can FLY, add 1 to the Hit roll.

**Keywords:** Fly, Khorne, Hell Blade, Vehicle, Chaos, Aircraft, Fly, Khorne, Hell Blade, Vehicle, Chaos, Aircraft, Fly, Aircraft, Hell Blade, Aircraft, Chaos, Vehicle, Khorne, Hell Blade, Fly, Hell Blade, Khorne, Fly, Chaos, Vehicle, Vehicle, Chaos, Aircraft, Khorne
