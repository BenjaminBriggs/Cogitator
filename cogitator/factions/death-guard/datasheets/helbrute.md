...
**Default Wargear:**
**This model is equipped with:** multi-melta; Helbrute fist; close combat weapon.

**Ranged Weapons**
| Name | Range | A | BS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Combi-bolter | 24 | 2 | 3 | 4 | 0 | 1 | lethal hits, rapid fire 2 |
...
| Multi-melta | 18 | 2 | 3 | 9 | -4 | D6 | melta 2, lethal hits |
| Plasma cannon | 36 | D3 | 3 | 8 | -3 | 3 | blast, hazardous, lethal hits |
| Twin autocannon | 48 | 2 | 3 | 10 | -1 | 3 | twin-linked, lethal hits |
| Twin heavy bolter | 36 | 3 | 3 | 5 | -1 | 2 | lethal hits, sustained hits 1, twin-linked |
...
| Helbrute hammer | Melee | 4 | 3 | 14 | -3 | D6+1 | — |
...
- **Diseased Malice** (Datasheet): Each time this model makes an attack that targets an Afflicted unit, add 1 to the Wound roll.
- **Froth-spattered Frenzy** (Datasheet): If this model is equipped with two melee weapons in addition to its close combat weapon, add 2 to the Attacks characteristic of those two weapons.

**Keywords:** Chaos, Nurgle, Helbrute, Walker, Vehicle
...
**Wargear Options:**
- This model’s multi-melta can be replaced with one of the following:- 1 plasma cannon
- 1 twin autocannon
- 1 twin lascannon
- 1 twin heavy bolter
- 1 additional Helbrute fist
- 1 of this model’s Helbrute fists can be replaced with 1 missile launcher
- 1 of this model’s Helbrute fists can be replaced with one of the following:- 1 Helbrute hammer
- 1 power scourge
- For each Helbrute fist this model is equipped with, it can be equipped with one of the following:- 1 combi-bolter*
- 1 heavy flamer*
