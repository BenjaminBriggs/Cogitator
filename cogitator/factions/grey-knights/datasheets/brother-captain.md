...
|---|---|---|---|---|---|---|---|
| Nemesis force weapon | Melee | 4 | 2 | 6 | -2 | 2 | psychic |
...
- **Hammerhand (Psychic)** (Datasheet): While this model is leading a unit, melee weapons equipped by models in that unit have the [LETHAL HITS] ability.
- **Eye of Judgement (Psychic)** (Datasheet): Each time this model makes an attack, you can re-roll the Wound roll.
