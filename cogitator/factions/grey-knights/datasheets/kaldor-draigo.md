...
|---|---|---|---|---|---|---|---|
| Scourging | 18 | 3 | 2 | 6 | -2 | 2 | anti-daemon 2+, ignores cover, psychic |
| Storm bolter | 24 | 2 | 2 | 4 | 0 | 1 | rapid fire 2 |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| The Titansword | Melee | 6 | 2 | 8 | -4 | 3 | anti-daemon 2+, psychic |
...
- **Untouchable Purity** (Datasheet): While this model is leading a unit, models in that unit have the Feel No Pain 4+ ability against mortal wounds.
- **One With the Warp (Psychic)** (Datasheet): Once per battle, when this model’s unit declares a charge in the same turn it was set up on the battlefield using the Deep Strike or Teleport Assault ability, add 3 to the Charge roll.
...
**Leader:**
Can lead: Brotherhood Terminator Squad, Paladin Squad
