...
- **Zealous Path** (Datasheet): While this model is leading a unit, you can re-roll Charge rolls made for that unit.
- **Litanies of Sanctity** (Datasheet): Once per battle, at the start of any phase, you can select one friendly Grey Knights unit that is Battle-shocked and within 12" of this model. That unit is no longer Battle-shocked.

**Keywords:** Infantry, Brotherhood Chaplain, Character, Psyker, Terminator, Imperium
