...
| Psilencer | 24 | 6 | 2 | 5 | 0 | 1 | precision, psychic, sustained hits 1 |
| Psycannon | 24 | 3 | 2 | 8 | -1 | 2 | psychic |
| Storm bolter | 24 | 2 | 2 | 4 | 0 | 1 | rapid fire 2 |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Nemesis force weapon | Melee | 5 | 2 | 6 | -2 | 2 | psychic |
...
- **Might of Titan (Psychic)** (Datasheet): Once per battle, at the start of the Fight phase, this model can use this ability. If it does, until the end of the phase, add 3 to the Attacks and Strength characteristics of melee weapons equipped by this model.

**Keywords:** Psyker, Grenades, Terminator, Imperium, Grand Master, Character, Infantry
...
**Wargear Options:**
- This model’s storm bolter can be replaced with one of the following:- 1 incinerator
- 1 psilencer
- 1 psycannon

**Leader:**
Can lead: Paladin Squad, Brotherhood Terminator Squad
