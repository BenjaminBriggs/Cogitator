...
|---|---|---|---|---|---|---|---|
| Hellstrike missile battery | 72 | 4 | 3 | 8 | -2 | 3 | anti-fly 4+ |
...
- **Thunderhawk Cluster Bombs** (Wargear): Each time the bearer ends a Normal move, you can select one enemy unit it moved over during that move and roll six D6: for each 3+, that unit suffers 1 mortal wound.
...
**Keywords:** Titanic, Thunderhawk Gunship, Imperium, Transport, Aircraft, Vehicle, Fly
