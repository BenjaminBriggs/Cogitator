...
|---|---|---|---|---|---|---|---|
| Gaze of Hate | 18 | 3 | 3 | 4 | -3 | 2 | anti-monster 4+, anti-vehicle 4+, devastating wounds, psychic |
| Inferno combi-bolter | 24 | 2 | 3 | 4 | -2 | 1 | rapid fire 2 |
| Inferno combi-weapon | 24 | 1 | 4 | 4 | -2 | 1 | anti-infantry 4+, devastating wounds, rapid fire 1 |
...
- **Empyric Guidance (Psychic)** (Datasheet): While this model is leading a unit, weapons equipped by models in that unit have the [LETHAL HITS] ability.
- **Marked by Fate (Psychic)** (Datasheet): At the start of your Shooting phase, select one enemy unit that is visible to this PSYKER model. Until the end of the phase, each time a model in this unit makes an attack that targets that enemy unit, add 1 to the Hit roll.

**Keywords:** Infantry, Character, Psyker, Terminator, Sorcerer, Chaos, Tzeentch
...
**Leader:**
Can lead: Scarab Occult Terminators
