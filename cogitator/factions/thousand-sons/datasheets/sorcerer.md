...
- **Twisted Sorceries (Psychic)** (Datasheet): Once per battle, in your Shooting phase or the Fight phase, this model can use this ability. If it does, until the end of the phase, improve the Strength and Attacks characteristics of Psychic weapons equipped by this model by 3.

**Keywords:** Infantry, Sorcerer, Tzeentch, Character, Psyker, Grenades, Chaos
