...
- **Kustom Force Field** (Wargear): While the bearer is leading a unit, models in that unit have a 4+ invulnerable save against ranged attacks.
- **More Dakka** (Datasheet): While this model is leading a unit, each time a model in that unit makes a ranged attack, re-roll a Hit roll of 1.
- **Mekaniak** (Datasheet): At the end of your Movement phase, you can select one friendly Orks Vehicle model within 3" of this model. That VEHICLE model regains up to D3 lost wounds, and, until the start of your next Movement phase, each time that VEHICLE model makes an attack, add 1 to the Hit roll. Each model can only be selected for this ability once per turn.

**Keywords:** Mounted, Speed Freeks, Grenades, Big Mek, Big Mek on Warbike, Character
...
**Wargear Options:**
- This model’s slugga can be replaced with one of the following:- 1 shokk attack gun
...
- 1 big choppa
- 1 power klaw
- This model’s choppa can be replaced with one of the following:- 1 kombi-weapon
- 1 kustom mega-blasta
- 1 kustom mega-slugga
- 1 rokkit launcha
- 1 big choppa
