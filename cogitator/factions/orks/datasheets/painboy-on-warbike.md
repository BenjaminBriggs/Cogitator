...
- **Hold Still and Say ‘Aargh!’** (Datasheet): Each time an attack made by this model with its ’urty syringe scores a Critical Wound against a unit (excluding VEHICLE units), that unit suffers D6 mortal wounds.

**Keywords:** Character, Speed Freeks, Mounted, Painboy on Warbike
