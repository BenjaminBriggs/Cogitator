...
*The Boomdakka Snazzwagon is a high-speed riot on wheels. Bristling with dakka and swarming with anarchic greenskin crew, the vehicle roars through the enemy lines in a storm of roiling smoke, whistling bullets, incendiary burna bottles and shockingly foul language before skidding around for another pass.*
...
| Mek speshul | 24 | 12 | 5 | 5 | -1 | 1 | assault, rapid fire 4, sustained hits 1 |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Spiked wheels | Melee | 4 | 4 | 7 | -1 | 2 | — |
...
- **Dust Trails (Aura)** (Datasheet): While an enemy unit (excluding MONSTERS and VEHICLES) is within 6" of this model, each time a model in that unit makes an attack, subtract 1 from the Hit roll.

**Keywords:** Boomdakka Snazzwagon, Grenades, Vehicle, Speed Freeks
