...
- **Spiked Ram** (Datasheet): Each time this model ends a Charge move, select one enemy unit within Engagement Range of it and roll one D6: on a 2-5, that enemy unit suffers D3 mortal wounds; on a 6, that enemy unit suffers 3 mortal wounds.
...
**Wargear Options:**
- This model can be equipped with one of the following:- 1 kannon
- 1 supa-kannon
