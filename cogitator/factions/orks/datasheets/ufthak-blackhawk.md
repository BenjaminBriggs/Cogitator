...
|---|---|---|---|---|---|---|---|
| Princess’ jaws | Melee | 2 | 4 | 4 | 0 | 1 | extra attacks |
| Snazzhammer | Melee | 4 | 3 | 10 | -2 | 2 | devastating wounds |
...
- **Tellyporta Tech** (Datasheet): While this model is leading a unit, models in that unit have the Deep Strike ability.
- **Gargantsmasha** (Datasheet): Each time this model makes an attack that targets a TITANIC unit, you can re-roll the Hit roll and you can re-roll the Wound roll.

**Keywords:** Epic Hero, Warboss, Grenades, Character, Infantry, Ufthak Blackhawk
...
**Leader:**
Can lead: Boyz, Breaka Boyz, Nobz
