...
*The Hammerhead Gunship epitomises the T’au way of war. Not only is this hover tank resilient and possessed of truly ferocious firepower, but it is also swift and manoeuvrable enough to outpace lumbering enemy war engines while keeping up with the Hunter Cadres’ rapid advances, feints and redeployments.*
...
| Twin pulse carbine | 20 | 2 | 4 | 5 | 0 | 1 | twin-linked |
...
- **Armour Hunter** (Datasheet): Each time this model makes an attack that targets a MONSTER or VEHICLE, add 1 to the Hit roll.
- **Targeting Array** (Datasheet): Each time this model is selected to shoot, you can re-roll one Hit roll or you can re-roll one Wound roll when resolving those attacks.
...
- This model’s 2 twin pulse carbines can be replaced with one of the following:- 2 accelerator burst cannons
