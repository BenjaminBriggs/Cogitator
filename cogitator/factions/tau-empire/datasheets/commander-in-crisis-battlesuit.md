...
- **Crisis Commander** (Datasheet): While this model is leading a unit, each time a model in that unit makes a ranged attack, re-roll a Hit roll of 1.
...
**Keywords:** Walker, Fly, Character, Battlesuit, Commander in Crisis Battlesuit, Vehicle
...
**Wargear Options:**
- This model’s burst cannon can be replaced with one of the following:- 1 airbursting fragmentation projector*
...
**Leader:**
Can lead: Crisis Battlesuits, Crisis Sunforge Battlesuits, Crisis Fireknife Battlesuits, Crisis Starscythe Battlesuits
