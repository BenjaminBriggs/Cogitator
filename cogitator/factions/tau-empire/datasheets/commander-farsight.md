...
- **Way of the Short Blade** (Datasheet): While this model is leading a unit, each time a model in that unit makes an attack that targets an enemy unit within 9", add 1 to the Wound roll.
- **Puretide's Teachings** (Datasheet): Once per battle round, you can target this model’s unit with a Stratagem. If it does, reduce the CP cost of that use of that Stratagem by 1CP.
- **INDEPENDENT POWER** (Special (правая колонка)): If your army includes COMMANDER FARSIGHT, it cannot include any Ethereal units. If your army includes any ETHEREAL units, it cannot include COMMANDER FARSIGHT.

**Keywords:** Character, Vehicle, Walker, Fly, Battlesuit, Commander Farsight, Epic Hero
...
**Leader:**
Can lead: Crisis Sunforge Battlesuits, Crisis Starscythe Battlesuits, Crisis Fireknife Battlesuits
