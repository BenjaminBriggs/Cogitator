...
|---|---|---|---|---|---|---|---|
| Servo-arc claw | Melee | 3 | 4 | 8 | -2 | 2 | anti-vehicle 4+, devastating wounds |
...
- **Seekers of Divine Arcana** (Datasheet): While this model is leading a unit, add 1 to the Objective Control characteristic of models in that unit.
- **Cogitative Instincts** (Datasheet): Enemy units that are set up on the battlefield as Reinforcements cannot be set up within 12" horizontally of this model.

**Keywords:** Character, Cult Mechanicus, Infantry, Imperium, Technoarcheologist, Tech-Priest
...
**Leader:**
Can lead: Servitor Battleclade, Skitarii Vanguard, Skitarii Rangers, Kataphron Destroyers, Kataphron Breachers, Fulgurite Electro-priests, Corpuscarii Electro-priests
