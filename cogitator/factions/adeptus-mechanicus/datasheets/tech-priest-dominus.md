...
| Macrostubber | 12 | 5 | 3 | 4 | 0 | 1 | pistol |
| Phosphor serpenta | 18 | 1 | 3 | 5 | -1 | 2 | ignores cover, pistol |
...
- **Lord of the Machine Cult** (Datasheet): While this model is leading a unit, models in that unit have the Feel No Pain 5+ ability. If that unit has the Electro-Priests keyword, models in that unit have the Feel No Pain 4+ ability instead.
- **Data-spike** (Datasheet): At the start of the Fight phase, you can select one enemy VEHICLE unit within Engagement Range of this model’s unit and roll one D6: on a 4+, that enemy unit suffers D6 mortal wounds and, until the end of the phase, the Weapon Skill characteristic of melee weapons equipped by that enemy unit is worsened by 1.

**Keywords:** Character, Infantry, Tech-Priest, Cult Mechanicus, Imperium, Dominus
