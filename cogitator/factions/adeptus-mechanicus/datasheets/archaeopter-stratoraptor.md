...
|---|---|---|---|---|---|---|---|
| Cognis heavy stubber | 36 | 3 | 4 | 4 | 0 | 1 | rapid fire 3, sustained hits 1 |
| Heavy phosphor blaster | 36 | 3 | 4 | 6 | -1 | 2 | ignores cover |
| Twin cognis lascannon | 48 | 1 | 4 | 12 | -3 | D6+1 | sustained hits 1, twin-linked |
...
- **Chaff Launcher** (Wargear): The bearer has the SMOKE keyword.
- **Command Uplink** (Wargear): Each time you select the bearer’s unit as the target of a Stratagem, roll one D6: on a 5+, you gain 1CP.
- **Strafing Run** (Datasheet): Each time this model makes a ranged attack that targets an enemy unit (excluding units that can FLY), add 1 to the Hit roll.

**Keywords:** Archaeopter Stratoraptor, Vehicle, Aircraft, Fly, Imperium, Skitarii
