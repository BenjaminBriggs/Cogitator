...
|---|---|---|---|---|---|---|---|
| Gauss annihilator | 120 | 1 | 4 | 16 | -4 | D6+6 | anti-fly 2+, lethal hits |
| Tesla arc | 6 | 6 | 4 | 4 | 0 | 1 | sustained hits 2 |
...
- **Phase Shift Generator (Aura)** (Datasheet): While a friendly NECRONS unit is within 3" of this Fortification, models in that unit have a 5+ invulnerable save against ranged attacks.
...
**Keywords:** Vehicle, Gauss Pylon, Titanic, Towering, Fortification
