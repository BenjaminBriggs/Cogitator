...
- **Death Sphere Bombardment** (Datasheet): Each time this model ends a Normal move, you can select one enemy unit it moved over during that move and roll six D6: for each 3+, that unit suffers 1 mortal wound.

**Keywords:** Night Shroud, Aircraft, Fly, Vehicle
