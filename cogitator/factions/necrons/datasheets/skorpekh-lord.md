...
- **United In Destruction** (Datasheet): While this model is leading a unit, melee weapons equipped by models in that unit have the [LETHAL HITS] ability.
- **Crimson Harvest** (Datasheet): Each time this model ends a Charge move, select one enemy unit within Engagement Range of this model and roll one D6: on a 2-5, that unit suffers D3 mortal wounds; on a 6, that unit suffers D3+3 mortal wounds.

**Keywords:** Character, Infantry, Skorpekh Lord, Destroyer Cult
