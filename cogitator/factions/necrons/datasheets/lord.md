...
| Lord’s blade | Melee | 3 | 3 | 8 | -3 | 2 | devastating wounds |
...
- **Relentless March** (Datasheet): While this model is leading a unit, add 1" to the Move characteristic of models in that unit.
- **The Lord’s Will** (Datasheet): While this model is leading a unit, you can target that unit with Stratagems even when it is Battle-shocked.

**Keywords:** Lord, Noble, Character, Infantry
