...
|---|---|---|---|---|---|---|---|
| Long rifle | 36 | 1 | 2 | 4 | -1 | 2 | precision |
...
- **Target Acquisition** (Datasheet): In your Shooting phase, after this unit has shot, select one enemy unit hit by one or more of those attacks made with a long rifle. Until the end of the phase, that enemy unit cannot have the Benefit of Cover.

**Keywords:** Mounted, Shroud Runners, Fly, Aeldari
