...
|---|---|---|---|---|---|---|---|
| Mind War | 18 | 1 | 2 | 5 | -2 | D6 | anti-character 4+, precision, psychic |
| Shuriken pistol | 12 | 1 | 2 | 4 | -1 | 1 | assault, pistol |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Staff of Ulthamar and witchblade | Melee | 3 | 2 | 5 | -1 | 2 | anti-infantry 2+, psychic |
...
- **Diviner of Futures** (Datasheet): At the start of your Command phase, if this model is on the battlefield, you gain 1CP.
- **Doom (Psychic)** (Datasheet): At the end of your Movement phase, select one enemy unit within 18" of and visible to this model. Until the start of your next Command phase, each time a friendly AELDARI model makes an attack that targets that enemy unit, add 1 to the Wound roll.

**Keywords:** Aeldari, Character, Infantry, Epic Hero, Eldrad Ulthran, Farseer, Psyker
...
**Leader:**
Can lead: Warlock Conclave, Guardian Defenders, Storm Guardians
