...
|---|---|---|---|---|---|---|---|
| Dread of the Deep Void | 24 | D6+2 | 3 | 3 | -2 | 1 | anti-infantry 2+, blast, hazardous, ignores cover, psychic |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Waystave | Melee | 3 | 2 | 3 | 0 | 3 | anti-infantry 2+, psychic |
...
- **Aethersense (Psychic)** (Datasheet): Enemy units that are set up on the battlefield from Reserves cannot be set up within 12" of this model.
- **Fury of the Void (Psychic)** (Datasheet): In your Shooting phase, after this model’s unit has shot, select one enemy unit hit by one or more attacks made with this model’s Dread of the Deep Void. Until the end of the turn, that unit is riven. Each time an AELDARI model from your army makes an attack that targets a riven unit, add 1 to the Strength characteristic of that attack.

**Keywords:** Aeldari, Infantry, Character, Epic Hero, Psyker, Anhrathe, Kharseth
...
**Leader:**
Can lead: Corsair Voidreavers, Corsair Voidscarred
