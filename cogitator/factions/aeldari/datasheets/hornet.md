...
- **Lightning Assault** (Datasheet): Each time this model ends a Normal move, you can select one enemy unit (excluding MONSTER and VEHICLE units) that it moved over during that move, then roll six D6: for each 4+, that enemy unit suffers 1 mortal wound.

**Keywords:** Aeldari, Hornet, Fly, Vehicle
...
**Wargear Options:**
- Each of this model’s Hornet pulse lasers can be replaced with one of the following:- Aeldari missile launcher
- Bright lance
- Scatter laser
- Shuriken cannon
- Starcannon
