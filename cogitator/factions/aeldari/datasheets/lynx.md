...
- **Speed of Vaul** (Datasheet): Each time this model Advances, do not make an Advance roll for it. Instead, until the end of the phase, add 9" to the Move characteristic of this model.
...
**Wargear Options:**
- This model’s shuriken cannon can be replaced with one of the following:- Aeldari missile launcher
- Bright lance
- Scatter laser
- Starcannon
