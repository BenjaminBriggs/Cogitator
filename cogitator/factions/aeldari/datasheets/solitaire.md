...
|---|---|---|---|---|---|---|---|
| Solitaire weapons | Melee | 9 | 2 | 6 | -2 | 2 | precision |

**Abilities:**
- **Fights First** (Core): FIGHTS FIRSTSome warriors attack with blinding speed, landing their blows before their foes can react.
...
- **Blitz** (Datasheet): Once per battle, in your Movement phase, before this model makes a Normal move, it can use this ability. If it does, until the end of the turn, add 2D6" to this model’s Move characteristic and add 3 to the Attacks characteristic of this model’s Solitaire weapons.
- **Blur of Movement** (Datasheet): This model is eligible to declare a charge in a turn in which it Advanced.
- **PATH OF DAMNATION** (Fortification (левая колонка)): This model cannot be your WARLORD.
...
**Keywords:** Character, Infantry, Epic Hero, Aeldari, Solitaire
