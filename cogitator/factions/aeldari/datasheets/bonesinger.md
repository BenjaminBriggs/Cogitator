...
|---|---|---|---|---|---|---|---|
| Psytronome shaper | Melee | 2 | 2 | 3 | 0 | D3 | psychic |
...
- **Way of the Shaper (Psychic)** (Datasheet): While this model is leading a unit, Wraith Construct models in that unit have the Feel No Pain 6+ ability.
- **Bonesinger** (Datasheet): While this model is within 3" of one or more friendly Wraith Construct or Asuryani Vehicle units, unless it is leading a unit, this model has the Lone Operative ability.
- **Psytronome Shaper** (Datasheet): In your Command phase, you can select one friendly Wraith Construct or Asuryani Vehicle model within 3" of this model. That WRAITH CONSTRUCT or ASURYANI VEHICLE model regains up to D3 lost wounds.

**Keywords:** Bonesinger, Aeldari, Psyker, Infantry, Character
...
**Leader:**
Can lead: Wraithguard, Wraithblades, Wraithlord
