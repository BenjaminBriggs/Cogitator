...
*Jetbikes add great speed to Warlocks’ already formidable array of powers. Many craftworlds deploy entire Skyrunner conclaves, although such formations are especially common in the Wild Rider clans of Saim-Hann.*
...
- **Runes of Battle (Psychic)** (Datasheet): Weapons equipped by models in this unit have the [IGNORES COVER] ability.
- **Psychic Communion (Psychic)** (Datasheet): Each time this unit is selected to shoot, for each Warlock model in this unit, until the end of the phase, add 1 to the Attacks and Strength characteristics of that model’s Destructor weapon for each other friendly Aeldari Psyker model within 6" of that model (to a maximum of +2).

**Keywords:** Psyker, Fly, Aeldari, Warlocks, Warlock Skyrunners, Mounted
