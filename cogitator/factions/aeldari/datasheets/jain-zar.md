...
|---|---|---|---|---|---|---|---|
| Silent Death | 12 | 6 | 2 | 6 | -2 | 1 | assault |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Blade of Destruction | Melee | 8 | 2 | 6 | -3 | 2 | anti-infantry 3+ |
