...
| Voidweaver haywire cannon | 24 | 3 | 3 | 4 | -1 | 3 | anti-vehicle 4+, devastating wounds |
...
- **Polychromatic Camouflage** (Datasheet): This unit can only be selected as the target of a ranged attack if the attacking model is within 18".

**Keywords:** Fly, Voidweaver, Vehicle, Aeldari
