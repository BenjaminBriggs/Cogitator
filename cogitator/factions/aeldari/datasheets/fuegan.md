...
|---|---|---|---|---|---|---|---|
| Searsong – beam | 12 | 3 | 2 | 8 | -3 | 2 | assault, melta 1, sustained hits 2 |
| Searsong – lance | 18 | 1 | 2 | 14 | -4 | D6 | assault, melta 6 |

**Melee Weapons**
| Name | Range | A | WS | S | AP | D | Keywords |
|---|---|---|---|---|---|---|---|
| Fire Axe | Melee | 6 | 2 | 5 | -4 | 3 | — |
...
- **Burning Lance** (Datasheet): While this model is leading a unit, add 6" to the Range characteristic of Melta weapons equipped by models in that unit.
- **Unquenchable Resolve** (Datasheet): The first time this model is destroyed, at the end of the phase, roll one D6: on a 2+, set this model back up on the battlefield as close as possible to where it was destroyed and not within Engagement Range of one or more enemy units, with its full wounds remaining.

**Keywords:** Epic Hero, Grenades, Character, Fuegan, Phoenix Lord, Aspect Warrior, Aeldari, Infantry
