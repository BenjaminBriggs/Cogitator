...
| Lasgun array | 24 | 6 | 4 | 3 | 0 | 1 | rapid fire 6 |
...
- **Mobile Command Vehicle** (Datasheet): In your Command phase, one Officer model embarked within this TRANSPORT can issue Orders even though it is not on the battlefield. When doing so, measure distances to and from this TRANSPORT.
- **One Shot** (Wargear profile): The bearer can only shoot with this weapon once per battle.

**Keywords:** Smoke, Chimera, Dedicated Transport, Transport, Squadron, Imperium, Vehicle
...
- This model’s multi-laser can be replaced with one of the following:- 1 heavy bolter*
- 1 heavy flamer*
