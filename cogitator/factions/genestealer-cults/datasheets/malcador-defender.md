...
- **Armoured Defender** (Datasheet): Each time you target this model with the Fire Overwatch Stratagem, hits are scored on unmodified Hit rolls of 5+ while resolving that Stratagem.
- **One Shot** (Wargear profile): The bearer can only shoot with this weapon once per battle.

**Keywords:** Malcador Defender, Smoke, Squadron, Imperium, Vehicle
...
**Wargear Options:**
- 2 of this model’s heavy bolters can be replaced with one of the following:- 2 autocannons
- 2 lascannons
