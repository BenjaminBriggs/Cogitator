...
- **Ablative Plating** (Datasheet): Once per battle, when an attack is allocated to this model, you change the Damage characteristic of that attack to 0.

**Keywords:** Squadron, Rogal Dorn Battle Tank, Imperium, Smoke, Vehicle
