...
|---|---|---|---|---|---|---|---|
| Prime claws and talons | Melee | 6 | 3 | 5 | -2 | 2 | anti-monster 5+, anti-vehicle 5+, twin-linked |
| Ravener heavy claws and talons | Melee | 3 | 3 | 5 | -2 | 2 | anti-monster 5+, anti-vehicle 5+, twin-linked |
...
- **Alpha Invader** (Datasheet): Weapons equipped by models in this unit have the [SUSTAINED HITS 1] ability.
- **Hypersensory Array** (Datasheet): Once per battle round, you can target this unit with the Rapid Ingress or Heroic Intervention Stratagem for 0CP, and can do so even if you have already targeted a different unit with that Stratagem this turn.

**Keywords:** Infantry, Great Devourer, Vanguard Invader, Burrowers, Hyperadapted Raveners, Character, Synapse
