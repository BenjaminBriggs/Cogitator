...
- **Furious Barrage** (Datasheet): Each time this model makes an attack with its storm eagle rockets that targets an enemy unit that contains five or more models, you can re-roll the Hit roll.
...
**Keywords:** Imperium, Artillery, Manticore Platform, Fortification
