...
- **Sentry Programming** (Datasheet): You can target this unit with the Fire Overwatch Stratagem for 0CP, and can do so even if you have already used that Stratagem on a different unit this phase.

**Keywords:** Imperium, Vehicle, Tarantula Battery
