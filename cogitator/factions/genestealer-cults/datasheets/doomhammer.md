...
| Magma cannon | 24 | D6+3 | 4 | 12 | -4 | D6 | blast, melta 6 |
...
- **Close-range Titan Killer** (Datasheet): Each time this model’s magma cannon targets a MONSTER or VEHICLE unit, that target is always considered to be within half range of that weapon.

**Keywords:** Titanic, Smoke, Vehicle, Transport, Imperium, Doomhammer
