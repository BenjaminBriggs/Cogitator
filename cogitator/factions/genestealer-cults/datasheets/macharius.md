...
- **Battlefield Control** (Datasheet): Each time this model makes a ranged attack, if it is within range of an objective marker you control, re-roll a Hit roll of 1.
- **One Shot** (Wargear profile): The bearer can only shoot with this weapon once per battle.

**Keywords:** Vehicle, Smoke, Macharius, Imperium, Titanic
...
**Wargear Options:**
- This model’s 2 heavy stubbers can be replaced with one of the following:- 2 heavy bolters
- 2 heavy flamers
