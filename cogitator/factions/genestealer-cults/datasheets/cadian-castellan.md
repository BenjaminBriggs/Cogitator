...
**Default Wargear:**
**This model is equipped with:** laspistol; chainsword.
...
- **Senior Officer** (Datasheet): While this model is leading a unit, ranged weapons equipped by models in that unit have the [SUSTAINED HITS 1] ability.
- **Get Back in the Fight** (Datasheet): While this model is leading a unit, that unit is eligible to shoot in a turn in which it Fell Back.
- **ORDERS** (Special (правая колонка)): This OFFICER can issue 2 Orders to Regiment units.

**Keywords:** Character, Grenades, Imperium, Infantry, Officer, Cadian Castellan
...
**Wargear Options:**
- This model’s chainsword can be replaced with one of the following:- 1 boltgun and 1 close combat weapon
- 1 power fist
- 1 power weapon
- This model’s laspistol can be replaced with one of the following:- 1 bolt pistol
- 1 plasma pistol

**Leader:**
Can lead: Cadian Shock Troops, Kasrkin
