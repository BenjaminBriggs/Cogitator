...
- **Destabilising Quakes** (Datasheet): In your Shooting phase, after this unit has shot, select one enemy unit hit by one or more of those attacks made with its tremor shells. That unit must take a Battle-shock test, subtracting 1 from the result.
- **Geomantic Hunters** (Datasheet): Up to twice per battle, in your Shooting phase, when this unit is selected to shoot, it can use this ability. If it does, until the end of the phase, each time a model in this unit makes an attack with its breacher ordnance, you can re-roll the Wound roll.

**Designer’s Note:** *Place two breacher ordnance tokens next to the unit, removing one each time this unit uses this ability.*

**Keywords:** Earthshakers, Artillery, Cthonian, Infantry
